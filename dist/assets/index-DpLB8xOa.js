 ...
 */var wm;function g0(){if(wm)return Ae;wm=1;var i=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),h=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),R=Symbol.iterator;function V(x){return x===null||typeof x!="object"?null:(x=R&&x[R]||x["@@iterator"],typeof x=="function"?x:null)}var F={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},G=Object.assign,j={};function B(x,q,le){this.props=x,this.context=q,this.refs=j,this.updater=le||F}B.prototype.isReactComponent={},B.prototype.setState=function(x,q){if(typeof x!="object"&&typeof x!="function"&&x!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,x,q,"setState")},B.prototype.forceUpdate=function(x){this.updater.enqueueForceUpdate(this,x,"forceUpdate")};function me(){}me.prototype=B.prototype;function ne(x,q,le){this.props=x,this.context=q,this.refs=j,this.updater=le||F}var ue=ne.prototype=new me;ue.constructor=ne,G(ue,B.prototype),ue.isPureReactComponent=!0;var pe=Array.isArray,Fe=Object.prototype.hasOwnProperty,Te={current:null},N={key:!0,ref:!0,__self:!0,__source:!0};function T(x,q,le){var Ie,Se={},Ne=null,Le=null;if(q!=null)for(Ie in q.ref!==void 0&&(Le=q.ref),q.key!==void 0&&(Ne=""+q.key),q)Fe.call(q,Ie)&&!N.hasOwnProperty(Ie)&&(Se[Ie]=q[Ie]);var Me=arguments.length-2;if(Me===1)Se.children=le;else if(1<Me){for(var Be=Array(Me),mt=0;mt<Me;mt++)Be[mt]=arguments[mt+2];Se.children=Be}if(x&&x.defaultProps)for(Ie in Me=x.defaultProps,Me)Se[Ie]===void 0&&(Se[Ie]=Me[Ie]);return{$$typeof:i,type:x,key:Ne,ref:Le,props:Se,_owner:Te.current}}function A(x,q){return{$$typeof:i,type:x.type,key:q,ref:x.ref,props:x.props,_owner:x._owner}}function k(x){return typeof x=="object"&&x!==null&&x.$$typeof===i}function D(x){var q={"=":"=0",":":"=2"};return"$"+x.replace(/[=:]/g,function(le){return q[le]})}var O=/\/+/g;function S(x,q){return typeof x=="object"&&x!==null&&x.key!=null?D(""+x.key):q.toString(36)}function et(x,q,le,Ie,Se){var Ne=typeof x;(Ne==="undefined"||Ne==="boolean")&&(x=null);var Le=!1;if(x===null)Le=!0;else switch(Ne){case"string":case"number":Le=!0;break;case"object":switch(x.$$typeof){case i:case e:Le=!0}}if(Le)return Le=x,Se=Se(Le),x=Ie===""?"."+S(Le,0):Ie,pe(Se)?(le="",x!=null&&(le=x.replace(O,"$&/")+"/"),et(Se,q,le,"",function(mt){return mt})):Se!=null&&(k(Se)&&(Se=A(Se,le+(!Se.key||Le&&Le.key===Se.key?"":(""+Se.key).replace(O,"$&/")+"/")+x)),q.push(Se)),1;if(Le=0,Ie=Ie===""?".":Ie+":",pe(x))for(var Me=0;Me<x.length;Me++){Ne=x[Me];var Be=Ie+S(Ne,Me);Le+=et(Ne,q,le,Be,Se)}else if(Be=V(x),typeof Be=="function")for(x=Be.call(x),Me=0;!(Ne=x.next()).done;)Ne=Ne.value,Be=Ie+S(Ne,Me++),Le+=et(Ne,q,le,Be,Se);else if(Ne==="object")throw q=String(x),Error("Objects are not valid as a React child (found: "+(q==="[object Object]"?"object with keys {"+Object.keys(x).join(", ")+"}":q)+"). If you meant to render a collection of children, use an array instead.");return Le}function kt(x,q,le){if(x==null)return x;var Ie=[],Se=0;return et(x,Ie,"","",function(Ne){return q.call(le,Ne,Se++)}),Ie}function Pt(x){if(x._status===-1){var q=x._result;q=q(),q.then(function(le){(x._status===0||x._status===-1)&&(x._status=1,x._result=le)},function(le){(x._status===0||x._status===-1)&&(x._status=2,x._result=le)}),x._status===-1&&(x._status=0,x._result=q)}if(x._status===1)return x._result.default;throw x._result}var ze={current:null},J={transition:null},he={ReactCurrentDispatcher:ze,ReactCurrentBatchConfig:J,ReactCurrentOwner:Te};function ee(){throw Error("act(...) is not supported in production builds of React.")}return Ae.Children={map:kt,forEach:function(x,q,le){kt(x,function(){q.apply(this,arguments)},le)},count:function(x){var q=0;return kt(x,function(){q++}),q},toArray:function(x){return kt(x,function(q){return q})||[]},only:function(x){if(!k(x))throw Error("React.Children.only expected to receive a single React element child.");return x}},Ae.Component=B,Ae.Fragment=t,Ae.Profiler=o,Ae.PureComponent=ne,Ae.StrictMode=s,Ae.Suspense=g,Ae.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=he,Ae.act=ee,Ae.cloneElement=function(x,q,le){if(x==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+x+".");var Ie=G({},x.props),Se=x.key,Ne=x.ref,Le=x._owner;if(q!=null){if(q.ref!==void 0&&(Ne=q.ref,Le=Te.current),q.key!==void 0&&(Se=""+q.key),x.type&&x.type.defaultProps)var Me=x.type.defaultProps;for(Be in q)Fe.call(q,Be)&&!N.hasOwnProperty(Be)&&(Ie[Be]=q[Be]===void 0&&Me!==void 0?Me[Be]:q[Be])}var Be=arguments.length-2;if(Be===1)Ie.children=le;else if(1<Be){Me=Array(Be);for(var mt=0;mt<Be;mt++)Me[mt]=arguments[mt+2];Ie.children=Me}return{$$typeof:i,type:x.type,key:Se,ref:Ne,props:Ie,_owner:Le}},Ae.createContext=function(x){return x={$$typeof:h,_currentValue:x,_currentValue2:x,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},x.Provider={$$typeof:u,_context:x},x.Consumer=x},Ae.createElement=T,Ae.createFactory=function(x){var q=T.bind(null,x);return q.type=x,q},Ae.createRef=function(){return{current:null}},Ae.forwardRef=function(x){return{$$typeof:m,render:x}},Ae.isValidElement=k,Ae.lazy=function(x){return{$$typeof:w,_payload:{_status:-1,_result:x},_init:Pt}},Ae.memo=function(x,q){return{$$typeof:v,type:x,compare:q===void 0?null:q}},Ae.startTransition=function(x){var q=J.transition;J.transition={};try{x()}finally{J.transition=q}},Ae.unstable_act=ee,Ae.useCallback=function(x,q){return ze.current.useCallback(x,q)},Ae.useContext=function(x){return ze.current.useContext(x)},Ae.useDebugValue=function(){},Ae.useDeferredValue=function(x){return ze.current.useDeferredValue(x)},Ae.useEffect=function(x,q){return ze.current.useEffect(x,q)},Ae.useId=function(){return ze.current.useId()},Ae.useImperativeHandle=function(x,q,le){return ze.current.useImperativeHandle(x,q,le)},Ae.useInsertionEffect=function(x,q){return ze.current.useInsertionEffect(x,q)},Ae.useLayoutEffect=function(x,q){return ze.current.useLayoutEffect(x,q)},Ae.useMemo=function(x,q){return ze.current.useMemo(x,q)},Ae.useReducer=function(x,q,le){return ze.current.useReducer(x,q,le)},Ae.useRef=function(x){return ze.current.useRef(x)},Ae.useState=function(x){return ze.current.useState(x)},Ae.useSyncExternalStore=function(x,q,le){return ze.current.useSyncExternalStore(x,q,le)},Ae.useTransition=function(){return ze.current.useTransition()},Ae.version="18.3.1",Ae}var Tm;function vd(){return Tm||(Tm=1,xh.exports=g0()),xh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Im;function y0(){if(Im)return pa;Im=1;var i=vd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,u={key:!0,ref:!0,__self:!0,__source:!0};function h(m,g,v){var w,R={},V=null,F=null;v!==void 0&&(V=""+v),g.key!==void 0&&(V=""+g.key),g.ref!==void 0&&(F=g.ref);for(w in g)s.call(g,w)&&!u.hasOwnProperty(w)&&(R[w]=g[w]);if(m&&m.defaultProps)for(w in g=m.defaultProps,g)R[w]===void 0&&(R[w]=g[w]);return{$$typeof:e,type:m,key:V,ref:F,props:R,_owner:o.current}}return pa.Fragment=t,pa.jsx=h,pa.jsxs=h,pa}var Sm;function _0(){return Sm||(Sm=1,Dh.exports=y0()),Dh.exports}var we=_0(),Vn=vd(),iu={},Vh={exports:{}},Qt={},Oh={exports:{}},Lh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Am;function v0(){return Am||(Am=1,function(i){function e(J,he){var ee=J.length;J.push(he);e:for(;0<ee;){var x=ee-1>>>1,q=J[x];if(0<o(q,he))J[x]=he,J[ee]=q,ee=x;else break e}}function t(J){return J.length===0?null:J[0]}function s(J){if(J.length===0)return null;var he=J[0],ee=J.pop();if(ee!==he){J[0]=ee;e:for(var x=0,q=J.length,le=q>>>1;x<le;){var Ie=2*(x+1)-1,Se=J[Ie],Ne=Ie+1,Le=J[Ne];if(0>o(Se,ee))Ne<q&&0>o(Le,Se)?(J[x]=Le,J[Ne]=ee,x=Ne):(J[x]=Se,J[Ie]=ee,x=Ie);else if(Ne<q&&0>o(Le,ee))J[x]=Le,J[Ne]=ee,x=Ne;else break e}}return he}function o(J,he){var ee=J.sortIndex-he.sortIndex;return ee!==0?ee:J.id-he.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;i.unstable_now=function(){return u.now()}}else{var h=Date,m=h.now();i.unstable_now=function(){return h.now()-m}}var g=[],v=[],w=1,R=null,V=3,F=!1,G=!1,j=!1,B=typeof setTimeout=="function"?setTimeout:null,me=typeof clearTimeout=="function"?clearTimeout:null,ne=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ue(J){for(var he=t(v);he!==null;){if(he.callback===null)s(v);else if(he.startTime<=J)s(v),he.sortIndex=he.expirationTime,e(g,he);else break;he=t(v)}}function pe(J){if(j=!1,ue(J),!G)if(t(g)!==null)G=!0,Pt(Fe);else{var he=t(v);he!==null&&ze(pe,he.startTime-J)}}function Fe(J,he){G=!1,j&&(j=!1,me(T),T=-1),F=!0;var ee=V;try{for(ue(he),R=t(g);R!==null&&(!(R.expirationTime>he)||J&&!D());){var x=R.callback;if(typeof x=="function"){R.callback=null,V=R.priorityLevel;var q=x(R.expirationTime<=he);he=i.unstable_now(),typeof q=="function"?R.callback=q:R===t(g)&&s(g),ue(he)}else s(g);R=t(g)}if(R!==null)var le=!0;else{var Ie=t(v);Ie!==null&&ze(pe,Ie.startTime-he),le=!1}return le}finally{R=null,V=ee,F=!1}}var Te=!1,N=null,T=-1,A=5,k=-1;function D(){return!(i.unstable_now()-k<A)}function O(){if(N!==null){var J=i.unstable_now();k=J;var he=!0;try{he=N(!0,J)}finally{he?S():(Te=!1,N=null)}}else Te=!1}var S;if(typeof ne=="function")S=function(){ne(O)};else if(typeof MessageChannel<"u"){var et=new MessageChannel,kt=et.port2;et.port1.onmessage=O,S=function(){kt.postMessage(null)}}else S=function(){B(O,0)};function Pt(J){N=J,Te||(Te=!0,S())}function ze(J,he){T=B(function(){J(i.unstable_now())},he)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(J){J.callback=null},i.unstable_continueExecution=function(){G||F||(G=!0,Pt(Fe))},i.unstable_forceFrameRate=function(J){0>J||125<J?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<J?Math.floor(1e3/J):5},i.unstable_getCurrentPriorityLevel=function(){return V},i.unstable_getFirstCallbackNode=function(){return t(g)},i.unstable_next=function(J){switch(V){case 1:case 2:case 3:var he=3;break;default:he=V}var ee=V;V=he;try{return J()}finally{V=ee}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(J,he){switch(J){case 1:case 2:case 3:case 4:case 5:break;default:J=3}var ee=V;V=J;try{return he()}finally{V=ee}},i.unstable_scheduleCallback=function(J,he,ee){var x=i.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?x+ee:x):ee=x,J){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=ee+q,J={id:w++,callback:he,priorityLevel:J,startTime:ee,expirationTime:q,sortIndex:-1},ee>x?(J.sortIndex=ee,e(v,J),t(g)===null&&J===t(v)&&(j?(me(T),T=-1):j=!0,ze(pe,ee-x))):(J.sortIndex=q,e(g,J),G||F||(G=!0,Pt(Fe))),J},i.unstable_shouldYield=D,i.unstable_wrapCallback=function(J){var he=V;return function(){var ee=V;V=he;try{return J.apply(this,arguments)}finally{V=ee}}}}(Lh)),Lh}var Rm;function E0(){return Rm||(Rm=1,Oh.exports=v0()),Oh.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fw=new Ma(3e4,6e4);function Cd(i,e){return i.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:i.tenantId}):e}async function po(i,e,t,s,o={}){return hy(i,o,async()=>{let u={},h={};s&&(e==="GET"?h=s:u={body:JSON.stringify(s)});const m=La(Object.assign({key:i.config.apiKey},h)).slice(1),g=await i._getAdditionalHeaders();g["Content-Type"]="application/json",i.languageCode&&(g["X-Firebase-Locale"]=i.languageCode);const v=Object.assign({method:e,headers:g},u);return b0()||(v.referrerPolicy="no-referrer"),cy.fetch()(dy(i,i.config.apiHost,t,m),v)})}async function hy(i,e,t){i._canInitEmulator=!1;const s=Object.assign(Object.assign({},dw),e);try{const o=new mw(i),u=await Promise.race([t(),o.promise]);o.clearNetworkTimeout();const h=await u.json();if("needConfirmation"in h)throw su(i,"account-exists-with-different-credential",h);if(u.ok&&!("errorMessage"in h))return h;{const m=u.ok?h.errorMessage:h.error.message,[g,v]=m.split(" : ");if(g==="FEDERATED_USER_ID_ALREADY_LINKED")throw su(i,"credential-already-in-use",h);if(g==="EMAIL_EXISTS")throw su(i,"email-already-in-use",h);if(g==="USER_DISABLED")throw su(i,"user-disabled",h);const w=s[g]||g.toLowerCase().replace(/[_\s]+/g,"-");if(v)throw Sd(i,w,v);Jn(i,w)}}catch(o){if(o instanceof Cr)throw o;Jn(i,"network-request-failed",{message:String(o)})}}async function pw(i,e,t,s,o={}){const u=await po(i,e,t,s,o);return"mfaPendingCredential"in u&&Jn(i,"multi-factor-auth-required",{_serverResponse:u}),u}function dy(i,e,t,s){const o=`${e}${t}?${s}`;return i.config.emulator?Rd(i.config,o):`${i.config.apiScheme}://${o}`}class mw{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,s)=>{this.timer=setTimeout(()=>s(Ln(this.auth,"network-request-failed")),fw.get())})}}function su(i,e,t){const s={appName:i.name};t.email&&(s.email=t.email),t.phoneNumber&&(s.phoneNumber=t.phoneNumber);const o=Ln(i,e,s);return o.customData._tokenResponse=t,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fu(i,e,t){return`firebase:${i}:${e}:${t}`}class Zs{constructor(e,t,s){this.persistence=e,this.auth=t,this.userKey=s;const{config:o,name:u}=this.auth;this.fullUserKey=fu(this.userKey,o.apiKey,u),this.fullPersistenceKey=fu("persistence",o.apiKey,u),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?wr._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,s="authUser"){if(!t.length)return new Zs(Tr($m),e,s);const o=(await Promise.all(t.map(async v=>{if(await v._isAvailable())return v}))).filter(v=>v);let u=o[0]||Tr($m);const h=fu(s,e.config.apiKey,e.name);let m=null;for(const v of t)try{const w=await v._get(h);if(w){const R=wr._fromJSON(e,w);v!==u&&(m=R),u=v;break}}catch{}const g=o.filter(v=>v._shouldAllowMigration);return!u._shouldAllowMigration||!g.length?new Zs(u,e,s):(u=g[0],m&&await u._set(h,m.toJSON()),await Promise.all(t.map(async v=>{if(v!==u)try{await v._remove(h)}catch{}})),new Zs(u,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class by{constructor(e,t,s,o,u=!1){this.auth=e,this.resolver=s,this.user=o,this.bypassAuthState=u,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:s,postBody:o,tenantId:u,error:h,type:m}=e;if(h){this.reject(h);return}const g={auth:this.auth,requestUri:t,sessionId:s,tenantId:u||void 0,postBody:o||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(m)(g))}catch(v){this.reject(v)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return lT;case"linkViaPopup":case"linkViaRedirect":return cT;case"reauthViaPopup":case"reauthViaRedirect":return uT;default:Jn(this.auth,"internal-error")}}resolve(e){Sr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Sr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kT=new Ma(3e4,6e4);function Ym(){const i=Kn().___jsl;if(i!=null&&i.H){for(const e of Object.keys(i.H))if(i.H[e].r=i.H[e].r||[],i.H[e].L=i.H[e].L||[],i.H[e].r=[...i.H[e].L],i.CP)for(let t=0;t<i.CP.length;t++)i.CP[t]=null}}function PT(i){return new Promise((e,t)=>{var s,o,u;function h(){Ym(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Ym(),t(Ln(i,"network-request-failed"))},timeout:kT.get()})}if(!((o=(s=Kn().gapi)===null||s===void 0?void 0:s.iframes)===null||o===void 0)&&o.Iframe)e(gapi.iframes.getContext());else if(!((u=Kn().gapi)===null||u===void 0)&&u.load)h();else{const m=Ow("iframefcb");return Kn()[m]=()=>{gapi.load?h():t(Ln(i,"network-request-failed"))},xw(`${Vw()}?onload=${m}`).catch(g=>t(g))}}).catch(e=>{throw mu=null,e})}let mu=null;function NT(i){return mu=mu||PT(i),mu}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function JT(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function ZT(i){no(new Qi("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),u=e.getProvider("app-check-internal"),{apiKey:h,authDomain:m}=s.options;_e(h&&!h.includes(":"),"invalid-api-key",{appName:s.name});const g={apiKey:h,authDomain:m,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Sy(i)},v=new Nw(s,o,u,g);return Mw(v,t),v},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),no(new Qi("auth-internal",e=>{const t=ju(e.getProvider("auth").getImmediate());return(s=>new YT(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),oi(eg,tg,JT(i)),oi(eg,tg,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Ki,Uy;(function(){var i;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(N,T){function A(){}A.prototype=T.prototype,N.D=T.prototype,N.prototype=new A,N.prototype.constructor=N,N.C=function(k,D,O){for(var S=Array(arguments.length-2),et=2;et<arguments.length;et++)S[et-2]=arguments[et];return T.prototype[D].apply(k,S)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(s,t),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(N,T,A){A||(A=0);var k=Array(16);if(typeof T=="string")for(var D=0;16>D;++D)k[D]=T.charCodeAt(A++)|T.charCodeAt(A++)<<8|T.charCodeAt(A++)<<16|T.charCodeAt(A++)<<24;else for(D=0;16>D;++D)k[D]=T[A++]|T[A++]<<8|T[A++]<<16|T[A++]<<24;T=N.g[0],A=N.g[1],D=N.g[2];var O=N.g[3],S=T+(O^A&(D^O))+k[0]+3614090360&4294967295;T=A+(S<<7&4294967295|S>>>25),S=O+(D^T&(A^D))+k[1]+3905402710&4294967295,O=T+(S<<12&4294967295|S>>>20),S=D+(A^O&(T^A))+k[2]+606105819&4294967295,D=O+(S<<17&4294967295|S>>>15),S=A+(T^D&(O^T))+k[3]+3250441966&4294967295,A=D+(S<<22&4294967295|S>>>10),S=T+(O^A&(D^O))+k[4]+4118548399&4294967295,T=A+(S<<7&4294967295|S>>>25),S=O+(D^T&(A^D))+k[5]+1200080426&4294967295,O=T+(S<<12&4294967295|S>>>20),S=D+(A^O&(T^A))+k[6]+2821735955&4294967295,D=O+(S<<17&4294967295|S>>>15),S=A+(T^D&(O^T))+k[7]+4249261313&4294967295,A=D+(S<<22&4294967295|S>>>10),S=T+(O^A&(D^O))+k[8]+1770035416&4294967295,T=A+(S<<7&4294967295|S>>>25),S=O+(D^T&(A^D))+k[9]+2336552879&4294967295,O=T+(S<<12&4294967295|S>>>20),S=D+(A^O&(T^A))+k[10]+4294925233&4294967295,D=O+(S<<17&4294967295|S>>>15),S=A+(T^D&(O^T))+k[11]+2304563134&4294967295,A=D+(S<<22&4294967295|S>>>10),S=T+(O^A&(D^O))+k[12]+1804603682&4294967295,T=A+(S<<7&4294967295|S>>>25),S=O+(D^T&(A^D))+k[13]+4254626195&4294967295,O=T+(S<<12&4294967295|S>>>20),S=D+(A^O&(T^A))+k[14]+2792965006&4294967295,D=O+(S<<17&4294967295|S>>>15),S=A+(T^D&(O^T))+k[15]+1236535329&4294967295,A=D+(S<<22&4294967295|S>>>10),S=T+(D^O&(A^D))+k[1]+4129170786&4294967295,T=A+(S<<5&4294967295|S>>>27),S=O+(A^D&(T^A))+k[6]+3225465664&4294967295,O=T+(S<<9&4294967295|S>>>23),S=D+(T^A&(O^T))+k[11]+643717713&4294967295,D=O+(S<<14&4294967295|S>>>18),S=A+(O^T&(D^O))+k[0]+3921069994&4294967295,A=D+(S<<20&4294967295|S>>>12),S=T+(D^O&(A^D))+k[5]+3593408605&4294967295,T=A+(S<<5&4294967295|S>>>27),S=O+(A^D&(T^A))+k[10]+38016083&4294967295,O=T+(S<<9&4294967295|S>>>23),S=D+(T^A&(O^T))+k[15]+3634488961&4294967295,D=O+(S<<14&4294967295|S>>>18),S=A+(O^T&(D^O))+k[4]+3889429448&4294967295,A=D+(S<<20&4294967295|S>>>12),S=T+(D^O&(A^D))+k[9]+568446438&4294967295,T=A+(S<<5&4294967295|S>>>27),S=O+(A^D&(T^A))+k[14]+3275163606&4294967295,O=T+(S<<9&4294967295|S>>>23),S=D+(T^A&(O^T))+k[3]+4107603335&4294967295,D=O+(S<<14&4294967295|S>>>18),S=A+(O^T&(D^O))+k[8]+1163531501&4294967295,A=D+(S<<20&4294967295|S>>>12),S=T+(D^O&(A^D))+k[13]+2850285829&4294967295,T=A+(S<<5&4294967295|S>>>27),S=O+(A^D&(T^A))+k[2]+4243563512&4294967295,O=T+(S<<9&4294967295|S>>>23),S=D+(T^A&(O^T))+k[7]+1735328473&4294967295,D=O+(S<<14&4294967295|S>>>18),S=A+(O^T&(D^O))+k[12]+2368359562&4294967295,A=D+(S<<20&4294967295|S>>>12),S=T+(A^D^O)+k[5]+4294588738&4294967295,T=A+(S<<4&4294967295|S>>>28),S=O+(T^A^D)+k[8]+2272392833&4294967295,O=T+(S<<11&4294967295|S>>>21),S=D+(O^T^A)+k[11]+1839030562&4294967295,D=O+(S<<16&4294967295|S>>>16),S=A+(D^O^T)+k[14]+4259657740&4294967295,A=D+(S<<23&4294967295|S>>>9),S=T+(A^D^O)+k[1]+2763975236&4294967295,T=A+(S<<4&4294967295|S>>>28),S=O+(T^A^D)+k[4]+1272893353&4294967295,O=T+(S<<11&4294967295|S>>>21),S=D+(O^T^A)+k[7]+4139469664&4294967295,D=O+(S<<16&4294967295|S>>>16),S=A+(D^O^T)+k[10]+3200236656&4294967295,A=D+(S<<23&4294967295|S>>>9),S=T+(A^D^O)+k[13]+681279174&4294967295,T=A+(S<<4&4294967295|S>>>28),S=O+(T^A^D)+k[0]+3936430074&4294967295,O=T+(S<<11&4294967295|S>>>21),S=D+(O^T^A)+k[3]+3572445317&4294967295,D=O+(S<<16&4294967295|S>>>16),S=A+(D^O^T)+k[6]+76029189&4294967295,A=D+(S<<23&4294967295|S>>>9),S=T+(A^D^O)+k[9]+3654602809&4294967295,T=A+(S<<4&4294967295|S>>>28),S=O+(T^A^D)+k[12]+3873151461&4294967295,O=T+(S<<11&4294967295|S>>>21),S=D+(O^T^A)+k[15]+530742520&4294967295,D=O+(S<<16&4294967295|S>>>16),S=A+(D^O^T)+k[2]+3299628645&4294967295,A=D+(S<<23&4294967295|S>>>9),S=T+(D^(A|~O))+k[0]+4096336452&4294967295,T=A+(S<<6&4294967295|S>>>26),S=O+(A^(T|~D))+k[7]+1126891415&4294967295,O=T+(S<<10&4294967295|S>>>22),S=D+(T^(O|~A))+k[14]+2878612391&4294967295,D=O+(S<<15&4294967295|S>>>17),S=A+(O^(D|~T))+k[5]+4237533241&4294967295,A=D+(S<<21&4294967295|S>>>11),S=T+(D^(A|~O))+k[12]+1700485571&4294967295,T=A+(S<<6&4294967295|S>>>26),S=O+(A^(T|~D))+k[3]+2399980690&4294967295,O=T+(S<<10&4294967295|S>>>22),S=D+(T^(O|~A))+k[10]+4293915773&4294967295,D=O+(S<<15&4294967295|S>>>17),S=A+(O^(D|~T))+k[1]+2240044497&4294967295,A=D+(S<<21&4294967295|S>>>11),S=T+(D^(A|~O))+k[8]+1873313359&4294967295,T=A+(S<<6&4294967295|S>>>26),S=O+(A^(T|~D))+k[15]+4264355552&4294967295,O=T+(S<<10&4294967295|S>>>22),S=D+(T^(O|~A))+k[6]+2734768916&4294967295,D=O+(S<<15&4294967295|S>>>17),S=A+(O^(D|~T))+k[13]+1309151649&4294967295,A=D+(S<<21&4294967295|S>>>11),S=T+(D^(A|~O))+k[4]+4149444226&4294967295,T=A+(S<<6&4294967295|S>>>26),S=O+(A^(T|~D))+k[11]+3174756917&4294967295,O=T+(S<<10&4294967295|S>>>22),S=D+(T^(O|~A))+k[2]+718787259&4294967295,D=O+(S<<15&4294967295|S>>>17),S=A+(O^(D|~T))+k[9]+3951481745&4294967295,N.g[0]=N.g[0]+T&4294967295,N.g[1]=N.g[1]+(D+(S<<21&4294967295|S>>>11))&4294967295,N.g[2]=N.g[2]+D&4294967295,N.g[3]=N.g[3]+O&4294967295}s.prototype.u=function(N,T){T===void 0&&(T=N.length);for(var A=T-this.blockSize,k=this.B,D=this.h,O=0;O<T;){if(D==0)for(;O<=A;)o(this,N,O),O+=this.blockSize;if(typeof N=="string"){for(;O<T;)if(k[D++]=N.charCodeAt(O++),D==this.blockSize){o(this,k),D=0;break}}else for(;O<T;)if(k[D++]=N[O++],D==this.blockSize){o(this,k),D=0;break}}this.h=D,this.o+=T},s.prototype.v=function(){var N=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);N[0]=128;for(var T=1;T<N.length-8;++T)N[T]=0;var A=8*this.o;for(T=N.length-8;T<N.length;++T)N[T]=A&255,A/=256;for(this.u(N),N=Array(16),T=A=0;4>T;++T)for(var k=0;32>k;k+=8)N[A++]=this.g[T]>>>k&255;return N};function u(N,T){var A=m;return Object.prototype.hasOwnProperty.call(A,N)?A[N]:A[N]=T(N)}function h(N,T){this.h=T;for(var A=[],k=!0,D=N.length-1;0<=D;D--){var O=N[D]|0;k&&O==T||(A[D]=O,k=!1)}this.g=A}var m={};function g(N){return-128<=N&&128>N?u(N,function(T){return new h([T|0],0>T?-1:0)}):new h([N|0],0>N?-1:0)}function v(N){if(isNaN(N)||!isFinite(N))return R;if(0>N)return B(v(-N));for(var T=[],A=1,k=0;N>=A;k++)T[k]=N/A|0,A*=4294967296;return new h(T,0)}function w(N,T){if(N.length==0)throw Error("number format error: empty string");if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(N.charAt(0)=="-")return B(w(N.substring(1),T));if(0<=N.indexOf("-"))throw Error('number format error: interior "-" character');for(var A=v(Math.pow(T,8)),k=R,D=0;D<N.length;D+=8){var O=Math.min(8,N.length-D),S=parseInt(N.substring(D,D+O),T);8>O?(O=v(Math.pow(T,O)),k=k.j(O).add(v(S))):(k=k.j(A),k=k.add(v(S)))}return k}var R=g(0),V=g(1),F=g(16777216);i=h.prototype,i.m=function(){if(j(this))return-B(this).m();for(var N=0,T=1,A=0;A<this.g.length;A++){var k=this.i(A);N+=(0<=k?k:4294967296+k)*T,T*=4294967296}return N},i.toString=function(N){if(N=N||10,2>N||36<N)throw Error("radix out of range: "+N);if(G(this))return"0";if(j(this))return"-"+B(this).toString(N);for(var T=v(Math.pow(N,6)),A=this,k="";;){var D=pe(A,T).g;A=me(A,D.j(T));var O=((0<A.g.length?A.g[0]:A.h)>>>0).toString(N);if(A=D,G(A))return O+k;for(;6>O.length;)O="0"+O;k=O+k}},i.i=function(N){return 0>N?0:N<this.g.length?this.g[N]:this.h};function G(N){if(N.h!=0)return!1;for(var T=0;T<N.g.length;T++)if(N.g[T]!=0)return!1;return!0}function j(N){return N.h==-1}i.l=function(N){return N=me(this,N),j(N)?-1:G(N)?0:1};function B(N){for(var T=N.g.length,A=[],k=0;k<T;k++)A[k]=~N.g[k];return new h(A,~N.h).add(V)}i.abs=function(){return j(this)?B(this):this},i.add=function(N){for(var T=Math.max(this.g.length,N.g.length),A=[],k=0,D=0;D<=T;D++){var O=k+(this.i(D)&65535)+(N.i(D)&65535),S=(O>>>16)+(this.i(D)>>>16)+(N.i(D)>>>16);k=S>>>16,O&=65535,S&=65535,A[D]=S<<16|O}return new h(A,A[A.length-1]&-2147483648?-1:0)};function me(N,T){return N.add(B(T))}i.j=function(N){if(G(this)||G(N))return R;if(j(this))return j(N)?B(this).j(B(N)):B(B(this).j(N));if(j(N))return B(this.j(B(N)));if(0>this.l(F)&&0>N.l(F))return v(this.m()*N.m());for(var T=this.g.length+N.g.length,A=[],k=0;k<2*T;k++)A[k]=0;for(k=0;k<this.g.length;k++)for(var D=0;D<N.g.length;D++){var O=this.i(k)>>>16,S=this.i(k)&65535,et=N.i(D)>>>16,kt=N.i(D)&65535;A[2*k+2*D]+=S*kt,ne(A,2*k+2*D),A[2*k+2*D+1]+=O*kt,ne(A,2*k+2*D+1),A[2*k+2*D+1]+=S*et,ne(A,2*k+2*D+1),A[2*k+2*D+2]+=O*et,ne(A,2*k+2*D+2)}for(k=0;k<T;k++)A[k]=A[2*k+1]<<16|A[2*k];for(k=T;k<2*T;k++)A[k]=0;return new h(A,0)};function ne(N,T){for(;(N[T]&65535)!=N[T];)N[T+1]+=N[T]>>>16,N[T]&=65535,T++}function ue(N,T){this.g=N,this.h=T}function pe(N,T){if(G(T))throw Error("division by zero");if(G(N))return new ue(R,R);if(j(N))return T=pe(B(N),T),new ue(B(T.g),B(T.h));if(j(T))return T=pe(N,B(T)),new ue(B(T.g),T.h);if(30<N.g.length){if(j(N)||j(T))throw Error("slowDivide_ only works with positive integers.");for(var A=V,k=T;0>=k.l(N);)A=Fe(A),k=Fe(k);var D=Te(A,1),O=Te(k,1);for(k=Te(k,2),A=Te(A,2);!G(k);){var S=O.add(k);0>=S.l(N)&&(D=D.add(A),O=S),k=Te(k,1),A=Te(A,1)}return T=me(N,D.j(T)),new ue(D,T)}for(D=R;0<=N.l(T);){for(A=Math.max(1,Math.floor(N.m()/T.m())),k=Math.ceil(Math.log(A)/Math.LN2),k=48>=k?1:Math.pow(2,k-48),O=v(A),S=O.j(T);j(S)||0<S.l(N);)A-=k,O=v(A),S=O.j(T);G(O)&&(O=V),D=D.add(O),N=me(N,S)}return new ue(D,N)}i.A=function(N){return pe(this,N).h},i.and=function(N){for(var T=Math.max(this.g.length,N.g.length),A=[],k=0;k<T;k++)A[k]=this.i(k)&N.i(k);return new h(A,this.h&N.h)},i.or=function(N){for(var T=Math.max(this.g.length,N.g.length),A=[],k=0;k<T;k++)A[k]=this.i(k)|N.i(k);return new h(A,this.h|N.h)},i.xor=function(N){for(var T=Math.max(this.g.length,N.g.length),A=[],k=0;k<T;k++)A[k]=this.i(k)^N.i(k);return new h(A,this.h^N.h)};function Fe(N){for(var T=N.g.length+1,A=[],k=0;k<T;k++)A[k]=N.i(k)<<1|N.i(k-1)>>>31;return new h(A,N.h)}function Te(N,T){var A=T>>5;T%=32;for(var k=N.g.length-A,D=[],O=0;O<k;O++)D[O]=0<T?N.i(O+A)>>>T|N.i(O+A+1)<<32-T:N.i(O+A);return new h(D,N.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,Uy=s,h.prototype.add=h.prototype.add,h.prototype.multiply=h.prototype.j,h.prototype.modulo=h.prototype.A,h.prototype.compare=h.prototype.l,h.prototype.toNumber=h.prototype.m,h.prototype.toString=h.prototype.toString,h.prototype.getBits=h.prototype.i,h.fromNumber=v,h.fromString=w,Ki=h}).apply(typeof rg<"u"?rg:typeof self<"u"?self:typeof window<"u"?window:{});var ou=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var zy,ma,jy,gu,rd,By,$y,qy;(function(){var i,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,f,y){return l==Array.prototype||l==Object.prototype||(l[f]=y.value),l};function t(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof ou=="object"&&ou];for(var f=0;f<l.length;++f){var y=l[f];if(y&&y.Math==Math)return y}throw Error("Cannot find global object")}var s=t(this);function o(l,f){if(f)e:{var y=s;l=l.split(".");for(var E=0;E<l.length-1;E++){var L=l[E];if(!(L in y))break e;y=y[L]}l=l[l.length-1],E=y[l],f=f(E),f!=E&&f!=null&&e(y,l,{configurable:!0,writable:!0,value:f})}}function u(l,f){l instanceof String&&(l+="");var y=0,E=!1,L={next:function(){if(!E&&y<l.length){var z=y++;return{value:f(z,l[z]),done:!1}}return E=!0,{done:!0,value:void 0}}};return L[Symbol.iterator]=function(){return L},L}o("Array.prototype.values",function(l){return l||function(){return u(this,function(f,y){return y})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var h=h||{},m=this||self;function g(l){var f=typeof l;return f=f!="object"?f:l?Array.isArray(l)?"array":f:"null",f=="array"||f=="object"&&typeof l.length=="number"}function v(l){var f=typeof l;return f=="object"&&l!=null||f=="function"}function w(l,f,y){return l.call.apply(l.bind,arguments)}function R(l,f,y){if(!l)throw Error();if(2<arguments.length){var E=Array.prototype.slice.call(arguments,2);return function(){var L=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(L,E),l.apply(f,L)}}return function(){return l.apply(f,arguments)}}function V(l,f,y){return V=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?w:R,V.apply(null,arguments)}function F(l,f){var y=Array.prototype.slice.call(arguments,1);return function(){var E=y.slice();return E.push.apply(E,arguments),l.apply(this,E)}}function G(l,f){function y(){}y.prototype=f.prototype,l.aa=f.prototype,l.prototype=new y,l.prototype.constructor=l,l.Qb=function(E,L,z){for(var Y=Array(arguments.length-2),Ue=2;Ue<arguments.length;Ue++)Y[Ue-2]=arguments[Ue];return f.prototype[L].apply(E,Y)}}function j(l){const f=l.length;if(0<f){const y=Array(f);for(let E=0;E<f;E++)y[E]=l[E];return y}return[]}function B(l,f){for(let y=1;y<arguments.length;y++){const E=arguments[y];if(g(E)){const L=l.length||0,z=E.length||0;l.length=L+z;for(let Y=0;Y<z;Y++)l[L+Y]=E[Y]}else l.push(E)}}class me{constructor(f,y){this.i=f,this.j=y,this.h=0,this.g=null}get(){let f;return 0<this.h?(this.h--,f=this.g,this.g=f.next,f.next=null):f=this.i(),f}}function ne(l){return/^[\s\xa0]*$/.test(l)}function ue(){var l=m.navigator;return l&&(l=l.userAgent)?l:""}function pe(l){return pe[" "](l),l}pe[" "]=function(){};var Fe=ue().indexOf("Gecko")!=-1&&!(ue().toLowerCase().indexOf("webkit")!=-1&&ue().indexOf("Edge")==-1)&&!(ue().indexOf("Trident")!=-1||ue().indexOf("MSIE")!=-1)&&ue().indexOf("Edge")==-1;function Te(l,f,y){for(const E in l)f.call(y,l[E],E,l)}function N(l,f){for(const y in l)f.call(void 0,l[y],y,l)}function T(l){const f={};for(const y in l)f[y]=l[y];return f}const A="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function k(l,f){let y,E;for(let L=1;L<arguments.length;L++){E=arguments[L];for(y in E)l[y]=E[y];for(let z=0;z<A.length;z++)y=A[z],Object.prototype.hasOwnProperty.call(E,y)&&(l[y]=E[y])}}function D(l){var f=1;l=l.split(":");const y=[];for(;0<f&&l.length;)y.push(l.shift()),f--;return l.length&&y.push(l.join(":")),y}function O(l){m.setTimeout(()=>{throw l},0)}function S(){var l=he;let f=null;return l.g&&(f=l.g,l.g=l.g.next,l.g||(l.h=null),f.next=null),f}class et{constructor(){this.h=this.g=null}add(f,y){const E=kt.get();E.set(f,y),this.h?this.h.next=E:this.g=E,this.h=E}}var kt=new me(()=>new Pt,l=>l.reset());class Pt{constructor(){this.next=this.g=this.h=null}set(f,y){this.h=f,this.g=y,this.next=null}reset(){this.next=this.g=this.h=null}}let ze,J=!1,he=new et,ee=()=>{const l=m.Promise.resolve(void 0);ze=()=>{l.then(x)}};var x=()=>{for(var l;l=S();){try{l.h.call(l.g)}catch(y){O(y)}var f=kt;f.j(l),100>f.h&&(f.h++,l.next=f.g,f.g=l)}J=!1};function q(){this.s=this.s,this.C=this.C}q.prototype.s=!1,q.prototype.ma=function(){this.s||(this.s=!0,this.N())},q.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function le(l,f){this.type=l,this.g=this.target=f,this.defaultPrevented=!1}le.prototype.h=function(){this.defaultPrevented=!0};var Ie=function(){if(!m.addEventListener||!Object.defineProperty)return!1;var l=!1,f=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const y=()=>{};m.addEventListener("test",y,f),m.removeEventListener("test",y,f)}catch{}return l}();function Se(l,f){if(le.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var y=this.type=l.type,E=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=f,f=l.relatedTarget){if(Fe){e:{try{pe(f.nodeName);var L=!0;break e}catch{}L=!1}L||(f=null)}}else y=="mouseover"?f=l.fromElement:y=="mouseout"&&(f=l.toElement);this.relatedTarget=f,E?(this.clientX=E.clientX!==void 0?E.clientX:E.pageX,this.clientY=E.clientY!==void 0?E.clientY:E.pageY,this.screenX=E.screenX||0,this.screenY=E.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:Ne[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&Se.aa.h.call(this)}}G(Se,le);var Ne={2:"touch",3:"pen",4:"mouse"};Se.prototype.h=function(){Se.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var Le="closure_listenable_"+(1e6*Math.random()|0),Me=0;function Be(l,f,y,E,L){this.listener=l,this.proxy=null,this.src=f,this.type=y,this.capture=!!E,this.ha=L,this.key=++Me,this.da=this.fa=!1}function mt(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function er(l){this.src=l,this.g={},this.h=0}er.prototype.add=function(l,f,y,E,L){var z=l.toString();l=this.g[z],l||(l=this.g[z]=[],this.h++);var Y=kr(l,f,E,L);return-1<Y?(f=l[Y],y||(f.fa=!1)):(f=new Be(f,this.src,z,!!E,L),f.fa=y,l.push(f)),f};function ns(l,f){var y=f.type;if(y in l.g){var E=l.g[y],L=Array.prototype.indexOf.call(E,f,void 0),z;(z=0<=L)&&Array.prototype.splice.call(E,L,1),z&&(mt(f),l.g[y].length==0&&(delete l.g[y],l.h--))}}function kr(l,f,y,E){for(var L=0;L<l.length;++L){var z=l[L];if(!z.da&&z.listener==f&&z.capture==!!y&&z.ha==E)return L}return-1}var gi="closure_lm_"+(1e6*Math.random()|0),rs={};function Eo(l,f,y,E,L){if(Array.isArray(f)){for(var z=0;z<f.length;z++)Eo(l,f[z],y,E,L);return null}return y=Io(y),l&&l[Le]?l.K(f,y,v(E)?!!E.capture:!!E,L):wo(l,f,y,!1,E,L)}function wo(l,f,y,E,L,z){if(!f)throw Error("Invalid event type");var Y=v(L)?!!L.capture:!!L,Ue=ss(l);if(Ue||(l[gi]=Ue=new er(l)),y=Ue.add(f,y,E,Y,z),y.proxy)return y;if(E=$a(),y.proxy=E,E.src=l,E.listener=y,l.addEventListener)Ie||(L=Y),L===void 0&&(L=!1),l.addEventListener(f.toString(),E,L);else if(l.attachEvent)l.attachEvent(nr(f.toString()),E);else if(l.addListener&&l.removeListener)l.addListener(E);else throw Error("addEventListener and attachEvent are unavailable.");return y}function $a(){function l(y){return f.call(l.src,l.listener,y)}const f=To;return l}function is(l,f,y,E,L){if(Array.isArray(f))for(var z=0;z<f.length;z++)is(l,f[z],y,E,L);else E=v(E)?!!E.capture:!!E,y=Io(y),l&&l[Le]?(l=l.i,f=String(f).toString(),f in l.g&&(z=l.g[f],y=kr(z,y,E,L),-1<y&&(mt(z[y]),Array.prototype.splice.call(z,y,1),z.length==0&&(delete l.g[f],l.h--)))):l&&(l=ss(l))&&(f=l.g[f.toString()],l=-1,f&&(l=kr(f,y,E,L)),(y=-1<l?f[l]:null)&&tr(y))}function tr(l){if(typeof l!="number"&&l&&!l.da){var f=l.src;if(f&&f[Le])ns(f.i,l);else{var y=l.type,E=l.proxy;f.removeEventListener?f.removeEventListener(y,E,l.capture):f.detachEvent?f.detachEvent(nr(y),E):f.addListener&&f.removeListener&&f.removeListener(E),(y=ss(f))?(ns(y,l),y.h==0&&(y.src=null,f[gi]=null)):mt(l)}}}function nr(l){return l in rs?rs[l]:rs[l]="on"+l}function To(l,f){if(l.da)l=!0;else{f=new Se(f,this);var y=l.listener,E=l.ha||l.src;l.fa&&tr(l),l=y.call(E,f)}return l}function ss(l){return l=l[gi],l instanceof er?l:null}var os="__closure_events_fn_"+(1e9*Math.random()>>>0);function Io(l){return typeof l=="function"?l:(l[os]||(l[os]=function(f){return l.handleEvent(f)}),l[os])}function lt(){q.call(this),this.i=new er(this),this.M=this,this.F=null}G(lt,q),lt.prototype[Le]=!0,lt.prototype.removeEventListener=function(l,f,y,E){is(this,l,f,y,E)};function ut(l,f){var y,E=l.F;if(E)for(y=[];E;E=E.F)y.push(E);if(l=l.M,E=f.type||f,typeof f=="string")f=new le(f,l);else if(f instanceof le)f.target=f.target||l;else{var L=f;f=new le(E,l),k(f,L)}if(L=!0,y)for(var z=y.length-1;0<=z;z--){var Y=f.g=y[z];L=rr(Y,E,!0,f)&&L}if(Y=f.g=l,L=rr(Y,E,!0,f)&&L,L=rr(Y,E,!1,f)&&L,y)for(z=0;z<y.length;z++)Y=f.g=y[z],L=rr(Y,E,!1,f)&&L}lt.prototype.N=function(){if(lt.aa.N.call(this),this.i){var l=this.i,f;for(f in l.g){for(var y=l.g[f],E=0;E<y.length;E++)mt(y[E]);delete l.g[f],l.h--}}this.F=null},lt.prototype.K=function(l,f,y,E){return this.i.add(String(l),f,!1,y,E)},lt.prototype.L=function(l,f,y,E){return this.i.add(String(l),f,!0,y,E)};function rr(l,f,y,E){if(f=l.i.g[String(f)],!f)return!0;f=f.concat();for(var L=!0,z=0;z<f.length;++z){var Y=f[z];if(Y&&!Y.da&&Y.capture==y){var Ue=Y.listener,ct=Y.ha||Y.src;Y.fa&&ns(l.i,Y),L=Ue.call(ct,E)!==!1&&L}}return L&&!E.defaultPrevented}function So(l,f,y){if(typeof l=="function")y&&(l=V(l,y));else if(l&&typeof l.handleEvent=="function")l=V(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(f)?-1:m.setTimeout(l,f||0)}function Pr(l){l.g=So(()=>{l.g=null,l.i&&(l.i=!1,Pr(l))},l.l);const f=l.h;l.h=null,l.m.apply(null,f)}class yi extends q{constructor(f,y){super(),this.m=f,this.l=y,this.h=null,this.i=!1,this.g=null}j(f){this.h=arguments,this.g?this.i=!0:Pr(this)}N(){super.N(),this.g&&(m.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function _i(l){q.call(this),this.h=l,this.g={}}G(_i,q);var Ao=[];function Ro(l){Te(l.g,function(f,y){this.g.hasOwnProperty(y)&&tr(f)},l),l.g={}}_i.prototype.N=function(){_i.aa.N.call(this),Ro(this)},_i.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Co=m.JSON.stringify,ko=m.JSON.parse,Po=class{stringify(l){return m.JSON.stringify(l,void 0)}parse(l){return m.JSON.parse(l,void 0)}};function vi(){}vi.prototype.h=null;function as(l){return l.h||(l.h=l.i())}function ls(){}var an={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function bn(){le.call(this,"d")}G(bn,le);function us(){le.call(this,"c")}G(us,le);var Fn={},No=null;function Ei(){return No=No||new lt}Fn.La="serverreachability";function Do(l){le.call(this,Fn.La,l)}G(Do,le);function ir(l){const f=Ei();ut(f,new Do(f))}Fn.STAT_EVENT="statevent";function xo(l,f){le.call(this,Fn.STAT_EVENT,l),this.stat=f}G(xo,le);function tt(l){const f=Ei();ut(f,new xo(f,l))}Fn.Ma="timingevent";function cs(l,f){le.call(this,Fn.Ma,l),this.size=f}G(cs,le);function _n(l,f){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return m.setTimeout(function(){l()},f)}function wi(){this.g=!0}wi.prototype.xa=function(){this.g=!1};function Ti(l,f,y,E,L,z){l.info(function(){if(l.g)if(z)for(var Y="",Ue=z.split("&"),ct=0;ct<Ue.length;ct++){var De=Ue[ct].split("=");if(1<De.length){var gt=De[0];De=De[1];var it=gt.split("_");Y=2<=it.length&&it[1]=="type"?Y+(gt+"="+De+"&"):Y+(gt+"=redacted&")}}else Y=null;else Y=z;return"XMLHTTP REQ ("+E+") [attempt "+L+"]: "+f+`
`+y+`
`+Y})}function hs(l,f,y,E,L,z,Y){l.info(function(){return"XMLHTTP RESP ("+E+") [ attempt "+L+"]: "+f+`
`+y+`
`+z+" "+Y})}function vn(l,f,y,E){l.info(function(){return"XMLHTTP TEXT ("+f+"): "+sc(l,y)+(E?" "+E:"")})}function Vo(l,f){l.info(function(){return"TIMEOUT: "+f})}wi.prototype.info=function(){};function sc(l,f){if(!l.g)return f;if(!f)return null;try{var y=JSON.parse(f);if(y){for(l=0;l<y.length;l++)if(Array.isArray(y[l])){var E=y[l];if(!(2>E.length)){var L=E[1];if(Array.isArray(L)&&!(1>L.length)){var z=L[0];if(z!="noop"&&z!="stop"&&z!="close")for(var Y=1;Y<L.length;Y++)L[Y]=""}}}}return Co(y)}catch{return f}}var ds={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},qa={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},En;function Ii(){}G(Ii,vi),Ii.prototype.g=function(){return new XMLHttpRequest},Ii.prototype.i=function(){return{}},En=new Ii;function wn(l,f,y,E){this.j=l,this.i=f,this.l=y,this.R=E||1,this.U=new _i(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Ha}function Ha(){this.i=null,this.g="",this.h=!1}var Oo={},fs={};function ps(l,f,y){l.L=1,l.v=Or(Zt(f)),l.m=y,l.P=!0,Lo(l,null)}function Lo(l,f){l.F=Date.now(),$e(l),l.A=Zt(l.v);var y=l.A,E=l.R;Array.isArray(E)||(E=[String(E)]),Mr(y.i,"t",E),l.C=0,y=l.j.J,l.h=new Ha,l.g=ul(l.j,y?f:null,!l.m),0<l.O&&(l.M=new yi(V(l.Y,l,l.g),l.O)),f=l.U,y=l.g,E=l.ca;var L="readystatechange";Array.isArray(L)||(L&&(Ao[0]=L.toString()),L=Ao);for(var z=0;z<L.length;z++){var Y=Eo(y,L[z],E||f.handleEvent,!1,f.h||f);if(!Y)break;f.g[Y.key]=Y}f=l.H?T(l.H):{},l.m?(l.u||(l.u="POST"),f["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,f)):(l.u="GET",l.g.ea(l.A,l.u,null,f)),ir(),Ti(l.i,l.u,l.A,l.l,l.R,l.m)}wn.prototype.ca=function(l){l=l.target;const f=this.M;f&&$t(l)==3?f.j():this.Y(l)},wn.prototype.Y=function(l){try{if(l==this.g)e:{const it=$t(this.g);var f=this.g.Ba();const cn=this.g.Z();if(!(3>it)&&(it!=3||this.g&&(this.h.h||this.g.oa()||jo(this.g)))){this.J||it!=4||f==7||(f==8||0>=cn?ir(3):ir(2)),Si(this);var y=this.g.Z();this.X=y;t:if(Wa(this)){var E=jo(this.g);l="";var L=E.length,z=$t(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){ln(this),Nr(this);var Y="";break t}this.h.i=new m.TextDecoder}for(f=0;f<L;f++)this.h.h=!0,l+=this.h.i.decode(E[f],{stream:!(z&&f==L-1)});E.length=0,this.h.g+=l,this.C=0,Y=this.h.g}else Y=this.g.oa();if(this.o=y==200,hs(this.i,this.u,this.A,this.l,this.R,it,y),this.o){if(this.T&&!this.K){t:{if(this.g){var Ue,ct=this.g;if((Ue=ct.g?ct.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!ne(Ue)){var De=Ue;break t}}De=null}if(y=De)vn(this.i,this.l,y,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Mo(this,y);else{this.o=!1,this.s=3,tt(12),ln(this),Nr(this);break e}}if(this.P){y=!0;let tn;for(;!this.J&&this.C<Y.length;)if(tn=oc(this,Y),tn==fs){it==4&&(this.s=4,tt(14),y=!1),vn(this.i,this.l,null,"[Incomplete Response]");break}else if(tn==Oo){this.s=4,tt(15),vn(this.i,this.l,Y,"[Invalid Chunk]"),y=!1;break}else vn(this.i,this.l,tn,null),Mo(this,tn);if(Wa(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),it!=4||Y.length!=0||this.h.h||(this.s=1,tt(16),y=!1),this.o=this.o&&y,!y)vn(this.i,this.l,Y,"[Invalid Chunked Response]"),ln(this),Nr(this);else if(0<Y.length&&!this.W){this.W=!0;var gt=this.j;gt.g==this&&gt.ba&&!gt.M&&(gt.j.info("Great, no buffering proxy detected. Bytes received: "+Y.length),$o(gt),gt.M=!0,tt(11))}}else vn(this.i,this.l,Y,null),Mo(this,Y);it==4&&ln(this),this.o&&!this.J&&(it==4?As(this.j,this):(this.o=!1,$e(this)))}else Es(this.g),y==400&&0<Y.indexOf("Unknown SID")?(this.s=3,tt(12)):(this.s=0,tt(13)),ln(this),Nr(this)}}}catch{}finally{}};function Wa(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function oc(l,f){var y=l.C,E=f.indexOf(`
`,y);return E==-1?fs:(y=Number(f.substring(y,E)),isNaN(y)?Oo:(E+=1,E+y>f.length?fs:(f=f.slice(E,E+y),l.C=E+y,f)))}wn.prototype.cancel=function(){this.J=!0,ln(this)};function $e(l){l.S=Date.now()+l.I,Ga(l,l.I)}function Ga(l,f){if(l.B!=null)throw Error("WatchDog timer not null");l.B=_n(V(l.ba,l),f)}function Si(l){l.B&&(m.clearTimeout(l.B),l.B=null)}wn.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(Vo(this.i,this.A),this.L!=2&&(ir(),tt(17)),ln(this),this.s=2,Nr(this)):Ga(this,this.S-l)};function Nr(l){l.j.G==0||l.J||As(l.j,l)}function ln(l){Si(l);var f=l.M;f&&typeof f.ma=="function"&&f.ma(),l.M=null,Ro(l.U),l.g&&(f=l.g,l.g=null,f.abort(),f.ma())}function Mo(l,f){try{var y=l.j;if(y.G!=0&&(y.g==l||Ft(y.h,l))){if(!l.K&&Ft(y.h,l)&&y.G==3){try{var E=y.Da.g.parse(f)}catch{E=null}if(Array.isArray(E)&&E.length==3){var L=E;if(L[0]==0){e:if(!y.u){if(y.g)if(y.g.F+3e3<l.F)Ss(y),Rn(y);else break e;Is(y),tt(18)}}else y.za=L[1],0<y.za-y.T&&37500>L[2]&&y.F&&y.v==0&&!y.C&&(y.C=_n(V(y.Za,y),6e3));if(1>=Qa(y.h)&&y.ca){try{y.ca()}catch{}y.ca=void 0}}else ur(y,11)}else if((l.K||y.g==l)&&Ss(y),!ne(f))for(L=y.Da.g.parse(f),f=0;f<L.length;f++){let De=L[f];if(y.T=De[0],De=De[1],y.G==2)if(De[0]=="c"){y.K=De[1],y.ia=De[2];const gt=De[3];gt!=null&&(y.la=gt,y.j.info("VER="+y.la));const it=De[4];it!=null&&(y.Aa=it,y.j.info("SVER="+y.Aa));const cn=De[5];cn!=null&&typeof cn=="number"&&0<cn&&(E=1.5*cn,y.L=E,y.j.info("backChannelRequestTimeoutMs_="+E)),E=y;const tn=l.g;if(tn){const Di=tn.g?tn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Di){var z=E.h;z.g||Di.indexOf("spdy")==-1&&Di.indexOf("quic")==-1&&Di.indexOf("h2")==-1||(z.j=z.l,z.g=new Set,z.h&&(bo(z,z.h),z.h=null))}if(E.D){const Cs=tn.g?tn.g.getResponseHeader("X-HTTP-Session-Id"):null;Cs&&(E.ya=Cs,je(E.I,E.D,Cs))}}y.G=3,y.l&&y.l.ua(),y.ba&&(y.R=Date.now()-l.F,y.j.info("Handshake RTT: "+y.R+"ms")),E=y;var Y=l;if(E.qa=ll(E,E.J?E.ia:null,E.W),Y.K){Xa(E.h,Y);var Ue=Y,ct=E.L;ct&&(Ue.I=ct),Ue.B&&(Si(Ue),$e(Ue)),E.g=Y}else Ni(E);0<y.i.length&&Bn(y)}else De[0]!="stop"&&De[0]!="close"||ur(y,7);else y.G==3&&(De[0]=="stop"||De[0]=="close"?De[0]=="stop"?ur(y,7):Tt(y):De[0]!="noop"&&y.l&&y.l.ta(De),y.v=0)}}ir(4)}catch{}}var Ka=class{constructor(l,f){this.g=l,this.map=f}};function Ai(l){this.l=l||10,m.PerformanceNavigationTiming?(l=m.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(m.chrome&&m.chrome.loadTimes&&m.chrome.loadTimes()&&m.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Jt(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function Qa(l){return l.h?1:l.g?l.g.size:0}function Ft(l,f){return l.h?l.h==f:l.g?l.g.has(f):!1}function bo(l,f){l.g?l.g.add(f):l.h=f}function Xa(l,f){l.h&&l.h==f?l.h=null:l.g&&l.g.has(f)&&l.g.delete(f)}Ai.prototype.cancel=function(){if(this.i=Ya(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function Ya(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let f=l.i;for(const y of l.g.values())f=f.concat(y.D);return f}return j(l.i)}function ms(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(g(l)){for(var f=[],y=l.length,E=0;E<y;E++)f.push(l[E]);return f}f=[],y=0;for(E in l)f[y++]=l[E];return f}function gs(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(g(l)||typeof l=="string"){var f=[];l=l.length;for(var y=0;y<l;y++)f.push(y);return f}f=[],y=0;for(const E in l)f[y++]=E;return f}}}function Dr(l,f){if(l.forEach&&typeof l.forEach=="function")l.forEach(f,void 0);else if(g(l)||typeof l=="string")Array.prototype.forEach.call(l,f,void 0);else for(var y=gs(l),E=ms(l),L=E.length,z=0;z<L;z++)f.call(void 0,E[z],y&&y[z],l)}var Ri=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ac(l,f){if(l){l=l.split("&");for(var y=0;y<l.length;y++){var E=l[y].indexOf("="),L=null;if(0<=E){var z=l[y].substring(0,E);L=l[y].substring(E+1)}else z=l[y];f(z,L?decodeURIComponent(L.replace(/\+/g," ")):"")}}}function sr(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof sr){this.h=l.h,Ci(this,l.j),this.o=l.o,this.g=l.g,xr(this,l.s),this.l=l.l;var f=l.i,y=new Un;y.i=f.i,f.g&&(y.g=new Map(f.g),y.h=f.h),Vr(this,y),this.m=l.m}else l&&(f=String(l).match(Ri))?(this.h=!1,Ci(this,f[1]||"",!0),this.o=ke(f[2]||""),this.g=ke(f[3]||"",!0),xr(this,f[4]),this.l=ke(f[5]||"",!0),Vr(this,f[6]||"",!0),this.m=ke(f[7]||"")):(this.h=!1,this.i=new Un(null,this.h))}sr.prototype.toString=function(){var l=[],f=this.j;f&&l.push(Lr(f,ys,!0),":");var y=this.g;return(y||f=="file")&&(l.push("//"),(f=this.o)&&l.push(Lr(f,ys,!0),"@"),l.push(encodeURIComponent(String(y)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),y=this.s,y!=null&&l.push(":",String(y))),(y=this.l)&&(this.g&&y.charAt(0)!="/"&&l.push("/"),l.push(Lr(y,y.charAt(0)=="/"?el:Za,!0))),(y=this.i.toString())&&l.push("?",y),(y=this.m)&&l.push("#",Lr(y,Fo)),l.join("")};function Zt(l){return new sr(l)}function Ci(l,f,y){l.j=y?ke(f,!0):f,l.j&&(l.j=l.j.replace(/:$/,""))}function xr(l,f){if(f){if(f=Number(f),isNaN(f)||0>f)throw Error("Bad port number "+f);l.s=f}else l.s=null}function Vr(l,f,y){f instanceof Un?(l.i=f,zn(l.i,l.h)):(y||(f=Lr(f,tl)),l.i=new Un(f,l.h))}function je(l,f,y){l.i.set(f,y)}function Or(l){return je(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function ke(l,f){return l?f?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function Lr(l,f,y){return typeof l=="string"?(l=encodeURI(l).replace(f,Ja),y&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function Ja(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var ys=/[#\/\?@]/g,Za=/[#\?:]/g,el=/[#\?]/g,tl=/[#\?@]/g,Fo=/#/g;function Un(l,f){this.h=this.g=null,this.i=l||null,this.j=!!f}function wt(l){l.g||(l.g=new Map,l.h=0,l.i&&ac(l.i,function(f,y){l.add(decodeURIComponent(f.replace(/\+/g," ")),y)}))}i=Un.prototype,i.add=function(l,f){wt(this),this.i=null,l=un(this,l);var y=this.g.get(l);return y||this.g.set(l,y=[]),y.push(f),this.h+=1,this};function Tn(l,f){wt(l),f=un(l,f),l.g.has(f)&&(l.i=null,l.h-=l.g.get(f).length,l.g.delete(f))}function In(l,f){return wt(l),f=un(l,f),l.g.has(f)}i.forEach=function(l,f){wt(this),this.g.forEach(function(y,E){y.forEach(function(L){l.call(f,L,E,this)},this)},this)},i.na=function(){wt(this);const l=Array.from(this.g.values()),f=Array.from(this.g.keys()),y=[];for(let E=0;E<f.length;E++){const L=l[E];for(let z=0;z<L.length;z++)y.push(f[E])}return y},i.V=function(l){wt(this);let f=[];if(typeof l=="string")In(this,l)&&(f=f.concat(this.g.get(un(this,l))));else{l=Array.from(this.g.values());for(let y=0;y<l.length;y++)f=f.concat(l[y])}return f},i.set=function(l,f){return wt(this),this.i=null,l=un(this,l),In(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[f]),this.h+=1,this},i.get=function(l,f){return l?(l=this.V(l),0<l.length?String(l[0]):f):f};function Mr(l,f,y){Tn(l,f),0<y.length&&(l.i=null,l.g.set(un(l,f),j(y)),l.h+=y.length)}i.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],f=Array.from(this.g.keys());for(var y=0;y<f.length;y++){var E=f[y];const z=encodeURIComponent(String(E)),Y=this.V(E);for(E=0;E<Y.length;E++){var L=z;Y[E]!==""&&(L+="="+encodeURIComponent(String(Y[E]))),l.push(L)}}return this.i=l.join("&")};function un(l,f){return f=String(f),l.j&&(f=f.toLowerCase()),f}function zn(l,f){f&&!l.j&&(wt(l),l.i=null,l.g.forEach(function(y,E){var L=E.toLowerCase();E!=L&&(Tn(this,E),Mr(this,L,y))},l)),l.j=f}function lc(l,f){const y=new wi;if(m.Image){const E=new Image;E.onload=F(Bt,y,"TestLoadImage: loaded",!0,f,E),E.onerror=F(Bt,y,"TestLoadImage: error",!1,f,E),E.onabort=F(Bt,y,"TestLoadImage: abort",!1,f,E),E.ontimeout=F(Bt,y,"TestLoadImage: timeout",!1,f,E),m.setTimeout(function(){E.ontimeout&&E.ontimeout()},1e4),E.src=l}else f(!1)}function nl(l,f){const y=new wi,E=new AbortController,L=setTimeout(()=>{E.abort(),Bt(y,"TestPingServer: timeout",!1,f)},1e4);fetch(l,{signal:E.signal}).then(z=>{clearTimeout(L),z.ok?Bt(y,"TestPingServer: ok",!0,f):Bt(y,"TestPingServer: server error",!1,f)}).catch(()=>{clearTimeout(L),Bt(y,"TestPingServer: error",!1,f)})}function Bt(l,f,y,E,L){try{L&&(L.onload=null,L.onerror=null,L.onabort=null,L.ontimeout=null),E(y)}catch{}}function uc(){this.g=new Po}function rl(l,f,y){const E=y||"";try{Dr(l,function(L,z){let Y=L;v(L)&&(Y=Co(L)),f.push(E+z+"="+encodeURIComponent(Y))})}catch(L){throw f.push(E+"type="+encodeURIComponent("_badmap")),L}}function or(l){this.l=l.Ub||null,this.j=l.eb||!1}G(or,vi),or.prototype.g=function(){return new ki(this.l,this.j)},or.prototype.i=function(l){return function(){return l}}({});function ki(l,f){lt.call(this),this.D=l,this.o=f,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}G(ki,lt),i=ki.prototype,i.open=function(l,f){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=f,this.readyState=1,An(this)},i.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const f={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(f.body=l),(this.D||m).fetch(new Request(this.A,f)).then(this.Sa.bind(this),this.ga.bind(this))},i.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Sn(this)),this.readyState=0},i.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,An(this)),this.g&&(this.readyState=3,An(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof m.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;il(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function il(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}i.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var f=l.value?l.value:new Uint8Array(0);(f=this.v.decode(f,{stream:!l.done}))&&(this.response=this.responseText+=f)}l.done?Sn(this):An(this),this.readyState==3&&il(this)}},i.Ra=function(l){this.g&&(this.response=this.responseText=l,Sn(this))},i.Qa=function(l){this.g&&(this.response=l,Sn(this))},i.ga=function(){this.g&&Sn(this)};function Sn(l){l.readyState=4,l.l=null,l.j=null,l.v=null,An(l)}i.setRequestHeader=function(l,f){this.u.append(l,f)},i.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},i.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],f=this.h.entries();for(var y=f.next();!y.done;)y=y.value,l.push(y[0]+": "+y[1]),y=f.next();return l.join(`\r
`)};function An(l){l.onreadystatechange&&l.onreadystatechange.call(l)}Object.defineProperty(ki.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(l){this.m=l?"include":"same-origin"}});function ar(l){let f="";return Te(l,function(y,E){f+=E,f+=":",f+=y,f+=`\r
`}),f}function br(l,f,y){e:{for(E in y){var E=!1;break e}E=!0}E||(y=ar(y),typeof l=="string"?y!=null&&encodeURIComponent(String(y)):je(l,f,y))}function Ke(l){lt.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}G(Ke,lt);var cc=/^https?$/i,Uo=["POST","PUT"];i=Ke.prototype,i.Ha=function(l){this.J=l},i.ea=function(l,f,y,E){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);f=f?f.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():En.g(),this.v=this.o?as(this.o):as(En),this.g.onreadystatechange=V(this.Ea,this);try{this.B=!0,this.g.open(f,String(l),!0),this.B=!1}catch(z){Pi(this,z);return}if(l=y||"",y=new Map(this.headers),E)if(Object.getPrototypeOf(E)===Object.prototype)for(var L in E)y.set(L,E[L]);else if(typeof E.keys=="function"&&typeof E.get=="function")for(const z of E.keys())y.set(z,E.get(z));else throw Error("Unknown input type for opt_headers: "+String(E));E=Array.from(y.keys()).find(z=>z.toLowerCase()=="content-type"),L=m.FormData&&l instanceof m.FormData,!(0<=Array.prototype.indexOf.call(Uo,f,void 0))||E||L||y.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[z,Y]of y)this.g.setRequestHeader(z,Y);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{vs(this),this.u=!0,this.g.send(l),this.u=!1}catch(z){Pi(this,z)}};function Pi(l,f){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=f,l.m=5,_s(l),en(l)}function _s(l){l.A||(l.A=!0,ut(l,"complete"),ut(l,"error"))}i.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,ut(this,"complete"),ut(this,"abort"),en(this))},i.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),en(this,!0)),Ke.aa.N.call(this)},i.Ea=function(){this.s||(this.B||this.u||this.j?zo(this):this.bb())},i.bb=function(){zo(this)};function zo(l){if(l.h&&typeof h<"u"&&(!l.v[1]||$t(l)!=4||l.Z()!=2)){if(l.u&&$t(l)==4)So(l.Ea,0,l);else if(ut(l,"readystatechange"),$t(l)==4){l.h=!1;try{const Y=l.Z();e:switch(Y){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var f=!0;break e;default:f=!1}var y;if(!(y=f)){var E;if(E=Y===0){var L=String(l.D).match(Ri)[1]||null;!L&&m.self&&m.self.location&&(L=m.self.location.protocol.slice(0,-1)),E=!cc.test(L?L.toLowerCase():"")}y=E}if(y)ut(l,"complete"),ut(l,"success");else{l.m=6;try{var z=2<$t(l)?l.g.statusText:""}catch{z=""}l.l=z+" ["+l.Z()+"]",_s(l)}}finally{en(l)}}}}function en(l,f){if(l.g){vs(l);const y=l.g,E=l.v[0]?()=>{}:null;l.g=null,l.v=null,f||ut(l,"ready");try{y.onreadystatechange=E}catch{}}}function vs(l){l.I&&(m.clearTimeout(l.I),l.I=null)}i.isActive=function(){return!!this.g};function $t(l){return l.g?l.g.readyState:0}i.Z=function(){try{return 2<$t(this)?this.g.status:-1}catch{return-1}},i.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},i.Oa=function(l){if(this.g){var f=this.g.responseText;return l&&f.indexOf(l)==0&&(f=f.substring(l.length)),ko(f)}};function jo(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function Es(l){const f={};l=(l.g&&2<=$t(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let E=0;E<l.length;E++){if(ne(l[E]))continue;var y=D(l[E]);const L=y[0];if(y=y[1],typeof y!="string")continue;y=y.trim();const z=f[L]||[];f[L]=z,z.push(y)}N(f,function(E){return E.join(", ")})}i.Ba=function(){return this.m},i.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function jn(l,f,y){return y&&y.internalChannelParams&&y.internalChannelParams[l]||f}function Bo(l){this.Aa=0,this.i=[],this.j=new wi,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=jn("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=jn("baseRetryDelayMs",5e3,l),this.cb=jn("retryDelaySeedMs",1e4,l),this.Wa=jn("forwardChannelMaxRetries",2,l),this.wa=jn("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new Ai(l&&l.concurrentRequestLimit),this.Da=new uc,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}i=Bo.prototype,i.la=8,i.G=1,i.connect=function(l,f,y,E){tt(0),this.W=l,this.H=f||{},y&&E!==void 0&&(this.H.OSID=y,this.H.OAID=E),this.F=this.X,this.I=ll(this,null,this.W),Bn(this)};function Tt(l){if(ws(l),l.G==3){var f=l.U++,y=Zt(l.I);if(je(y,"SID",l.K),je(y,"RID",f),je(y,"TYPE","terminate"),lr(l,y),f=new wn(l,l.j,f),f.L=2,f.v=Or(Zt(y)),y=!1,m.navigator&&m.navigator.sendBeacon)try{y=m.navigator.sendBeacon(f.v.toString(),"")}catch{}!y&&m.Image&&(new Image().src=f.v,y=!0),y||(f.g=ul(f.j,null),f.g.ea(f.v)),f.F=Date.now(),$e(f)}al(l)}function Rn(l){l.g&&($o(l),l.g.cancel(),l.g=null)}function ws(l){Rn(l),l.u&&(m.clearTimeout(l.u),l.u=null),Ss(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&m.clearTimeout(l.s),l.s=null)}function Bn(l){if(!Jt(l.h)&&!l.s){l.s=!0;var f=l.Ga;ze||ee(),J||(ze(),J=!0),he.add(f,l),l.B=0}}function hc(l,f){return Qa(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=f.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=_n(V(l.Ga,l,f),ol(l,l.B)),l.B++,!0)}i.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const L=new wn(this,this.j,l);let z=this.o;if(this.S&&(z?(z=T(z),k(z,this.S)):z=this.S),this.m!==null||this.O||(L.H=z,z=null),this.P)e:{for(var f=0,y=0;y<this.i.length;y++){t:{var E=this.i[y];if("__data__"in E.map&&(E=E.map.__data__,typeof E=="string")){E=E.length;break t}E=void 0}if(E===void 0)break;if(f+=E,4096<f){f=y;break e}if(f===4096||y===this.i.length-1){f=y+1;break e}}f=1e3}else f=1e3;f=Fr(this,L,f),y=Zt(this.I),je(y,"RID",l),je(y,"CVER",22),this.D&&je(y,"X-HTTP-Session-Id",this.D),lr(this,y),z&&(this.O?f="headers="+encodeURIComponent(String(ar(z)))+"&"+f:this.m&&br(y,this.m,z)),bo(this.h,L),this.Ua&&je(y,"TYPE","init"),this.P?(je(y,"$req",f),je(y,"SID","null"),L.T=!0,ps(L,y,null)):ps(L,y,f),this.G=2}}else this.G==3&&(l?Ts(this,l):this.i.length==0||Jt(this.h)||Ts(this))};function Ts(l,f){var y;f?y=f.l:y=l.U++;const E=Zt(l.I);je(E,"SID",l.K),je(E,"RID",y),je(E,"AID",l.T),lr(l,E),l.m&&l.o&&br(E,l.m,l.o),y=new wn(l,l.j,y,l.B+1),l.m===null&&(y.H=l.o),f&&(l.i=f.D.concat(l.i)),f=Fr(l,y,1e3),y.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),bo(l.h,y),ps(y,E,f)}function lr(l,f){l.H&&Te(l.H,function(y,E){je(f,E,y)}),l.l&&Dr({},function(y,E){je(f,E,y)})}function Fr(l,f,y){y=Math.min(l.i.length,y);var E=l.l?V(l.l.Na,l.l,l):null;e:{var L=l.i;let z=-1;for(;;){const Y=["count="+y];z==-1?0<y?(z=L[0].g,Y.push("ofs="+z)):z=0:Y.push("ofs="+z);let Ue=!0;for(let ct=0;ct<y;ct++){let De=L[ct].g;const gt=L[ct].map;if(De-=z,0>De)z=Math.max(0,L[ct].g-100),Ue=!1;else try{rl(gt,Y,"req"+De+"_")}catch{E&&E(gt)}}if(Ue){E=Y.join("&");break e}}}return l=l.i.splice(0,y),f.D=l,E}function Ni(l){if(!l.g&&!l.u){l.Y=1;var f=l.Fa;ze||ee(),J||(ze(),J=!0),he.add(f,l),l.v=0}}function Is(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=_n(V(l.Fa,l),ol(l,l.v)),l.v++,!0)}i.Fa=function(){if(this.u=null,sl(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=_n(V(this.ab,this),l)}},i.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,tt(10),Rn(this),sl(this))};function $o(l){l.A!=null&&(m.clearTimeout(l.A),l.A=null)}function sl(l){l.g=new wn(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var f=Zt(l.qa);je(f,"RID","rpc"),je(f,"SID",l.K),je(f,"AID",l.T),je(f,"CI",l.F?"0":"1"),!l.F&&l.ja&&je(f,"TO",l.ja),je(f,"TYPE","xmlhttp"),lr(l,f),l.m&&l.o&&br(f,l.m,l.o),l.L&&(l.g.I=l.L);var y=l.g;l=l.ia,y.L=1,y.v=Or(Zt(f)),y.m=null,y.P=!0,Lo(y,l)}i.Za=function(){this.C!=null&&(this.C=null,Rn(this),Is(this),tt(19))};function Ss(l){l.C!=null&&(m.clearTimeout(l.C),l.C=null)}function As(l,f){var y=null;if(l.g==f){Ss(l),$o(l),l.g=null;var E=2}else if(Ft(l.h,f))y=f.D,Xa(l.h,f),E=1;else return;if(l.G!=0){if(f.o)if(E==1){y=f.m?f.m.length:0,f=Date.now()-f.F;var L=l.B;E=Ei(),ut(E,new cs(E,y)),Bn(l)}else Ni(l);else if(L=f.s,L==3||L==0&&0<f.X||!(E==1&&hc(l,f)||E==2&&Is(l)))switch(y&&0<y.length&&(f=l.h,f.i=f.i.concat(y)),L){case 1:ur(l,5);break;case 4:ur(l,10);break;case 3:ur(l,6);break;default:ur(l,2)}}}function ol(l,f){let y=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(y*=2),y*f}function ur(l,f){if(l.j.info("Error code "+f),f==2){var y=V(l.fb,l),E=l.Xa;const L=!E;E=new sr(E||"//www.google.com/images/cleardot.gif"),m.location&&m.location.protocol=="http"||Ci(E,"https"),Or(E),L?lc(E.toString(),y):nl(E.toString(),y)}else tt(2);l.G=0,l.l&&l.l.sa(f),al(l),ws(l)}i.fb=function(l){l?(this.j.info("Successfully pinged google.com"),tt(2)):(this.j.info("Failed to ping google.com"),tt(1))};function al(l){if(l.G=0,l.ka=[],l.l){const f=Ya(l.h);(f.length!=0||l.i.length!=0)&&(B(l.ka,f),B(l.ka,l.i),l.h.i.length=0,j(l.i),l.i.length=0),l.l.ra()}}function ll(l,f,y){var E=y instanceof sr?Zt(y):new sr(y);if(E.g!="")f&&(E.g=f+"."+E.g),xr(E,E.s);else{var L=m.location;E=L.protocol,f=f?f+"."+L.hostname:L.hostname,L=+L.port;var z=new sr(null);E&&Ci(z,E),f&&(z.g=f),L&&xr(z,L),y&&(z.l=y),E=z}return y=l.D,f=l.ya,y&&f&&je(E,y,f),je(E,"VER",l.la),lr(l,E),E}function ul(l,f,y){if(f&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return f=l.Ca&&!l.pa?new Ke(new or({eb:y})):new Ke(l.pa),f.Ha(l.J),f}i.isActive=function(){return!!this.l&&this.l.isActive(this)};function qo(){}i=qo.prototype,i.ua=function(){},i.ta=function(){},i.sa=function(){},i.ra=function(){},i.isActive=function(){return!0},i.Na=function(){};function Rs(){}Rs.prototype.g=function(l,f){return new Ut(l,f)};function Ut(l,f){lt.call(this),this.g=new Bo(f),this.l=l,this.h=f&&f.messageUrlParams||null,l=f&&f.messageHeaders||null,f&&f.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=f&&f.initMessageHeaders||null,f&&f.messageContentType&&(l?l["X-WebChannel-Content-Type"]=f.messageContentType:l={"X-WebChannel-Content-Type":f.messageContentType}),f&&f.va&&(l?l["X-WebChannel-Client-Profile"]=f.va:l={"X-WebChannel-Client-Profile":f.va}),this.g.S=l,(l=f&&f.Sb)&&!ne(l)&&(this.g.m=l),this.v=f&&f.supportsCrossDomainXhr||!1,this.u=f&&f.sendRawJson||!1,(f=f&&f.httpSessionIdParam)&&!ne(f)&&(this.g.D=f,l=this.h,l!==null&&f in l&&(l=this.h,f in l&&delete l[f])),this.j=new $n(this)}G(Ut,lt),Ut.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Ut.prototype.close=function(){Tt(this.g)},Ut.prototype.o=function(l){var f=this.g;if(typeof l=="string"){var y={};y.__data__=l,l=y}else this.u&&(y={},y.__data__=Co(l),l=y);f.i.push(new Ka(f.Ya++,l)),f.G==3&&Bn(f)},Ut.prototype.N=function(){this.g.l=null,delete this.j,Tt(this.g),delete this.g,Ut.aa.N.call(this)};function cl(l){bn.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var f=l.__sm__;if(f){e:{for(const y in f){l=y;break e}l=void 0}(this.i=l)&&(l=this.i,f=f!==null&&l in f?f[l]:void 0),this.data=f}else this.data=l}G(cl,bn);function hl(){us.call(this),this.status=1}G(hl,us);function $n(l){this.g=l}G($n,qo),$n.prototype.ua=function(){ut(this.g,"a")},$n.prototype.ta=function(l){ut(this.g,new cl(l))},$n.prototype.sa=function(l){ut(this.g,new hl)},$n.prototype.ra=function(){ut(this.g,"b")},Rs.prototype.createWebChannel=Rs.prototype.g,Ut.prototype.send=Ut.prototype.o,Ut.prototype.open=Ut.prototype.m,Ut.prototype.close=Ut.prototype.close,qy=function(){return new Rs},$y=function(){return Ei()},By=Fn,rd={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},ds.NO_ERROR=0,ds.TIMEOUT=8,ds.HTTP_ERROR=6,gu=ds,qa.COMPLETE="complete",jy=qa,ls.EventType=an,an.OPEN="a",an.CLOSE="b",an.ERROR="c",an.MESSAGE="d",lt.prototype.listen=lt.prototype.K,ma=ls,Ke.prototype.listenOnce=Ke.prototype.L,Ke.prototype.getLastError=Ke.prototype.Ka,Ke.prototype.getLastErrorCode=Ke.prototype.Ba,Ke.prototype.getStatus=Ke.prototype.Z,Ke.prototype.getResponseJson=Ke.prototype.Oa,Ke.prototype.getResponseText=Ke.prototype.oa,Ke.prototype.send=Ke.prototype.ea,Ke.prototype.setWithCredentials=Ke.prototype.Ha,zy=Ke}).apply(typeof ou<"u"?ou:typeof self<"u"?self:typeof window<"u"?window:{});const ig="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yn{constructor(e){this.value=e}static empty(){return new yn({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let s=0;s<e.length-1;++s)if(t=(t.mapValue.fields||{})[e.get(s)],!_u(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Ea(t)}setAll(e){let t=Rt.emptyPath(),s={},o=[];e.forEach((h,m)=>{if(!t.isImmediateParentOf(m)){const g=this.getFieldsMap(t);this.applyChanges(g,s,o),s={},o=[],t=m.popLast()}h?s[m.lastSegment()]=Ea(h):o.push(m.lastSegment())});const u=this.getFieldsMap(t);this.applyChanges(u,s,o)}delete(e){const t=this.field(e.popLast());_u(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Zn(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let s=0;s<e.length;++s){let o=t.mapValue.fields[e.get(s)];_u(o)&&o.mapValue.fields||(o={mapValue:{fields:{}}},t.mapValue.fields[e.get(s)]=o),t=o}return t.mapValue.fields}applyChanges(e,t,s){Ji(t,(o,u)=>e[o]=u);for(const o of s)delete e[o]}clone(){return new yn(Ea(this.value))}}function Qy(i){const e=[];return Ji(i.fields,(t,s)=>{const o=new Rt([t]);if(_u(s)){const u=Qy(s.mapValue).fields;if(u.length===0)e.push(o);else for(const h of u)e.push(o.child(h))}else e.push(o)}),new On(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ri{constructor(e,t,s,o,u=ve.min(),h=ve.min(),m=Ct.EMPTY_BYTE_STRING,g=null){this.target=e,this.targetId=t,this.purpose=s,this.sequenceNumber=o,this.snapshotVersion=u,this.lastLimboFreeSnapshotVersion=h,this.resumeToken=m,this.expectedCount=g}withSequenceNumber(e){return new ri(this.target,this.targetId,this.purpose,e,this.snapshotVersion,this.lastLimboFreeSnapshotVersion,this.resumeToken,this.expectedCount)}withResumeToken(e,t){return new ri(this.target,this.targetId,this.purpose,this.sequenceNumber,t,this.lastLimboFreeSnapshotVersion,e,null)}withExpectedCount(e){return new ri(this.target,this.targetId,this.purpose,this.sequenceNumber,this.snapshotVersion,this.lastLimboFreeSnapshotVersion,this.resumeToken,e)}withLastLimboFreeSnapshotVersion(e){return new ri(this.target,this.targetId,this.purpose,this.sequenceNumber,this.snapshotVersion,e,this.resumeToken,this.expectedCount)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class L1{constructor(e,t,s,o){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=s,this.indexManager=o}getDocument(e,t){let s=null;return this.documentOverlayCache.getOverlay(e,t).next(o=>(s=o,this.remoteDocumentCache.getEntry(e,t))).next(o=>(s!==null&&Ia(s.mutation,o,On.empty(),ft.now()),o))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(s=>this.getLocalViewOfDocuments(e,s,Ce()).next(()=>s))}getLocalViewOfDocuments(e,t,s=Ce()){const o=Wi();return this.populateOverlays(e,o,t).next(()=>this.computeViews(e,t,o,s).next(u=>{let h=ga();return u.forEach((m,g)=>{h=h.insert(m,g.overlayedDocument)}),h}))}getOverlayedDocuments(e,t){const s=Wi();return this.populateOverlays(e,s,t).next(()=>this.computeViews(e,t,s,Ce()))}populateOverlays(e,t,s){const o=[];return s.forEach(u=>{t.has(u)||o.push(u)}),this.documentOverlayCache.getOverlays(e,o).next(u=>{u.forEach((h,m)=>{t.set(h,m)})})}computeViews(e,t,s,o){let u=Rr();const h=Ta(),m=function(){return Ta()}();return t.forEach((g,v)=>{const w=s.get(v.key);o.has(v.key)&&(w===void 0||w.mutation instanceof es)?u=u.insert(v.key,v):w!==void 0?(h.set(v.key,w.mutation.getFieldMask()),Ia(w.mutation,v,w.mutation.getFieldMask(),ft.now())):h.set(v.key,On.empty())}),this.recalculateAndSaveOverlays(e,u).next(g=>(g.forEach((v,w)=>h.set(v,w)),t.forEach((v,w)=>{var R;return m.set(v,new O1(w,(R=h.get(v))!==null&&R!==void 0?R:null))}),m))}recalculateAndSaveOverlays(e,t){const s=Ta();let o=new Je((h,m)=>h-m),u=Ce();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(h=>{for(const m of h)m.keys().forEach(g=>{const v=t.get(g);if(v===null)return;let w=s.get(g)||On.empty();w=m.applyToLocalView(v,w),s.set(g,w);const R=(o.get(m.batchId)||Ce()).add(g);o=o.insert(m.batchId,R)})}).next(()=>{const h=[],m=o.getReverseIterator();for(;m.hasNext();){const g=m.getNext(),v=g.key,w=g.value,R=a_();w.forEach(V=>{if(!u.has(V)){const F=f_(t.get(V),s.get(V));F!==null&&R.set(V,F),u=u.add(V)}}),h.push(this.documentOverlayCache.saveOverlays(e,v,R))}return $.waitFor(h)}).next(()=>s)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(s=>this.recalculateAndSaveOverlays(e,s))}getDocumentsMatchingQuery(e,t,s,o){return function(h){return ce.isDocumentKey(h.path)&&h.collectionGroup===null&&h.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):n_(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,s,o):this.getDocumentsMatchingCollectionQuery(e,t,s,o)}getNextDocuments(e,t,s,o){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,s,o).next(u=>{const h=o-u.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,s.largestBatchId,o-u.size):$.resolve(Wi());let m=-1,g=u;return h.next(v=>$.forEach(v,(w,R)=>(m<R.largestBatchId&&(m=R.largestBatchId),u.get(w)?$.resolve():this.remoteDocumentCache.getEntry(e,w).next(V=>{g=g.insert(w,V)}))).next(()=>this.populateOverlays(e,v,u)).next(()=>this.computeViews(e,g,v,Ce())).next(w=>({batchId:m,changes:o_(w)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new ce(t)).next(s=>{let o=ga();return s.isFoundDocument()&&(o=o.insert(s.key,s)),o})}getDocumentsMatchingCollectionGroupQuery(e,t,s,o){const u=t.collectionGroup;let h=ga();return this.indexManager.getCollectionParents(e,u).next(m=>$.forEach(m,g=>{const v=function(R,V){return new _o(V,null,R.explicitOrderBy.slice(),R.filters.slice(),R.limit,R.limitType,R.startAt,R.endAt)}(t,g.child(u));return this.getDocumentsMatchingCollectionQuery(e,v,s,o).next(w=>{w.forEach((R,V)=>{h=h.insert(R,V)})})}).next(()=>h))}getDocumentsMatchingCollectionQuery(e,t,s,o){let u;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,s.largestBatchId).next(h=>(u=h,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,s,u,o))).next(h=>{u.forEach((g,v)=>{const w=v.getKey();h.get(w)===null&&(h=h.insert(w,Mt.newInvalidDocument(w)))});let m=ga();return h.forEach((g,v)=>{const w=u.get(g);w!==void 0&&Ia(w.mutation,v,On.empty(),ft.now()),Ku(t,v)&&(m=m.insert(g,v))}),m})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class W1{constructor(e,t,s,o){this.persistence=e,this._s=t,this.serializer=o,this.us=new Je(Pe),this.cs=new Zi(u=>bd(u),Fd),this.ls=new Map,this.hs=e.getRemoteDocumentCache(),this.Gr=e.getTargetCache(),this.jr=e.getBundleCache(),this.Ps(s)}Ps(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new L1(this.hs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.hs.setIndexManager(this.indexManager),this._s.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.us))}}function G1(i,e,t,s){return new W1(i,e,t,s)}async function R_(i,e){const t=Ee(i);return await t.persistence.runTransaction("Handle user change","readonly",s=>{let o;return t.mutationQueue.getAllMutationBatches(s).next(u=>(o=u,t.Ps(e),t.mutationQueue.getAllMutationBatches(s))).next(u=>{const h=[],m=[];let g=Ce();for(const v of o){h.push(v.batchId);for(const w of v.mutations)g=g.add(w.key)}for(const v of u){m.push(v.batchId);for(const w of v.mutations)g=g.add(w.key)}return t.localDocuments.getDocuments(s,g).next(v=>({Ts:v,removedBatchIds:h,addedBatchIds:m}))})})}function K1(i,e){const t=Ee(i);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",s=>{const o=e.batch.keys(),u=t.hs.newChangeBuffer({trackRemovals:!0});return function(m,g,v,w){const R=v.batch,V=R.keys();let F=$.resolve();return V.forEach(G=>{F=F.next(()=>w.getEntry(g,G)).next(j=>{const B=v.docVersions.get(G);be(B!==null),j.version.compareTo(B)<0&&(R.applyToRemoteDocument(j,v),j.isValidDocument()&&(j.setReadTime(v.commitVersion),w.addEntry(j)))})}),F.next(()=>m.mutationQueue.removeMutationBatch(g,R))}(t,s,e,u).next(()=>u.apply(s)).next(()=>t.mutationQueue.performConsistencyCheck(s)).next(()=>t.documentOverlayCache.removeOverlaysForBatchId(s,o,e.batch.batchId)).next(()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(s,function(m){let g=Ce();for(let v=0;v<m.mutationResults.length;++v)m.mutationResults[v].transformResults.length>0&&(g=g.add(m.batch.mutations[v].key));return g}(e))).next(()=>t.localDocuments.getDocuments(s,o))})}function C_(i){const e=Ee(i);return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Gr.getLastRemoteSnapshotVersion(t))}function Q1(i,e){const t=Ee(i),s=e.snapshotVersion;let o=t.us;return t.persistence.runTransaction("Apply remote event","readwrite-primary",u=>{const h=t.hs.newChangeBuffer({trackRemovals:!0});o=t.us;const m=[];e.targetChanges.forEach((w,R)=>{const V=o.get(R);if(!V)return;m.push(t.Gr.removeMatchingKeys(u,w.removedDocuments,R).next(()=>t.Gr.addMatchingKeys(u,w.addedDocuments,R)));let F=V.withSequenceNumber(u.currentSequenceNumber);e.targetMismatches.get(R)!==null?F=F.withResumeToken(Ct.EMPTY_BYTE_STRING,ve.min()).withLastLimboFreeSnapshotVersion(ve.min()):w.resumeToken.approximateByteSize()>0&&(F=F.withResumeToken(w.resumeToken,s)),o=o.insert(R,F),function(j,B,me){return j.resumeToken.approximateByteSize()===0||B.snapshotVersion.toMicroseconds()-j.snapshotVersion.toMicroseconds()>=3e8?!0:me.addedDocuments.size+me.modifiedDocuments.size+me.removedDocuments.size>0}(V,F,w)&&m.push(t.Gr.updateTargetData(u,F))});let g=Rr(),v=Ce();if(e.documentUpdates.forEach(w=>{e.resolvedLimboDocuments.has(w)&&m.push(t.persistence.referenceDelegate.updateLimboDocument(u,w))}),m.push(X1(u,h,e.documentUpdates).next(w=>{g=w.Is,v=w.Es})),!s.isEqual(ve.min())){const w=t.Gr.getLastRemoteSnapshotVersion(u).next(R=>t.Gr.setTargetsMetadata(u,u.currentSequenceNumber,s));m.push(w)}return $.waitFor(m).next(()=>h.apply(u)).next(()=>t.localDocuments.getLocalViewOfDocuments(u,g,v)).next(()=>g)}).then(u=>(t.us=o,u))}function X1(i,e,t){let s=Ce(),o=Ce();return t.forEach(u=>s=s.add(u)),e.getEntries(i,s).next(u=>{let h=Rr();return t.forEach((m,g)=>{const v=u.get(m);g.isFoundDocument()!==v.isFoundDocument()&&(o=o.add(m)),g.isNoDocument()&&g.version.isEqual(ve.min())?(e.removeEntry(m,g.readTime),h=h.insert(m,g)):!v.isValidDocument()||g.version.compareTo(v.version)>0||g.version.compareTo(v.version)===0&&v.hasPendingWrites?(e.addEntry(g),h=h.insert(m,g)):te("LocalStore","Ignoring outdated watch update for ",m,". Current version:",v.version," Watch version:",g.version)}),{Is:h,Es:o}})}function Y1(i,e){const t=Ee(i);return t.persistence.runTransaction("Get next mutation batch","readonly",s=>(e===void 0&&(e=-1),t.mutationQueue.getNextMutationBatchAfterBatchId(s,e)))}function J1(i,e){const t=Ee(i);return t.persistence.runTransaction("Allocate target","readwrite",s=>{let o;return t.Gr.getTargetData(s,e).next(u=>u?(o=u,$.resolve(o)):t.Gr.allocateTargetId(s).next(h=>(o=new ri(e,h,"TargetPurposeListen",s.currentSequenceNumber),t.Gr.addTargetData(s,o).next(()=>o))))}).then(s=>{const o=t.us.get(s.targetId);return(o===null||s.snapshotVersion.compareTo(o.snapshotVersion)>0)&&(t.us=t.us.insert(s.targetId,s),t.cs.set(e,s.targetId)),s})}async function pd(i,e,t){const s=Ee(i),o=s.us.get(e),u=t?"readwrite":"readwrite-primary";try{t||await s.persistence.runTransaction("Release target",u,h=>s.persistence.referenceDelegate.removeTarget(h,o))}catch(h){if(!yo(h))throw h;te("LocalStore",`Failed to update sequence numbers for target ${e}: ${h}`)}s.us=s.us.remove(e),s.cs.delete(o.target)}function kg(i,e,t){const s=Ee(i);let o=ve.min(),u=Ce();return s.persistence.runTransaction("Execute query","readwrite",h=>function(g,v,w){const R=Ee(g),V=R.cs.get(w);return V!==void 0?$.resolve(R.us.get(V)):R.Gr.getTargetData(v,w)}(s,h,Qn(e)).next(m=>{if(m)return o=m.lastLimboFreeSnapshotVersion,s.Gr.getMatchingKeysForTargetId(h,m.targetId).next(g=>{u=g})}).next(()=>s._s.getDocumentsMatchingQuery(h,e,t?o:ve.min(),t?u:Ce())).next(m=>(Z1(s,UI(e),m),{documents:m,ds:u})))}function Z1(i,e,t){let s=i.ls.get(e)||ve.min();t.forEach((o,u)=>{u.readTime.compareTo(s)>0&&(s=u.readTime)}),i.ls.set(e,s)}class Pg{constructor(){this.activeTargetIds=HI()}ps(e){this.activeTargetIds=this.activeTargetIds.add(e)}ys(e){this.activeTargetIds=this.activeTargetIds.delete(e)}gs(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class eS{constructor(){this._o=new Pg,this.ao={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,s){}addLocalQueryTarget(e,t=!0){return t&&this._o.ps(e),this.ao[e]||"not-current"}updateQueryState(e,t,s){this.ao[e]=t}removeLocalQueryTarget(e){this._o.ys(e)}isLocalQueryTarget(e){return this._o.activeTargetIds.has(e)}clearQueryState(e){delete this.ao[e]}getAllActiveQueryTargets(){return this._o.activeTargetIds}isActiveQueryTarget(e){return this._o.activeTargetIds.has(e)}start(){return this._o=new Pg,Promise.resolve()}handleUserChange(e,t,s){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ot="WebChannelConnection";class iS extends class{get Co(){return!1}constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const s=t.ssl?"https":"http",o=encodeURIComponent(this.databaseId.projectId),u=encodeURIComponent(this.databaseId.database);this.Fo=s+"://"+t.host,this.Mo=`projects/${o}/databases/${u}`,this.xo=this.databaseId.database==="(default)"?`project_id=${o}`:`project_id=${o}&database_id=${u}`}Oo(t,s,o,u,h){const m=qh(),g=this.No(t,s.toUriEncodedString());te("RestConnection",`Sending RPC '${t}' ${m}:`,g,o);const v={"google-cloud-resource-prefix":this.Mo,"x-goog-request-params":this.xo};return this.Lo(v,u,h),this.Bo(t,g,v,o).then(w=>(te("RestConnection",`Received RPC '${t}' ${m}: `,w),w),w=>{throw io("RestConnection",`RPC '${t}' ${m} failed with error: `,w,"url: ",g,"request:",o),w})}ko(t,s,o,u,h,m){return this.Oo(t,s,o,u,h)}Lo(t,s,o){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+mo}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),s&&s.headers.forEach((u,h)=>t[h]=u),o&&o.headers.forEach((u,h)=>t[h]=u)}No(t,s){const o=nS[t];return`${this.Fo}/v1/${s}:${o}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Bo(e,t,s,o){const u=qh();return new Promise((h,m)=>{const g=new zy;g.setWithCredentials(!0),g.listenOnce(jy.COMPLETE,()=>{try{switch(g.getLastErrorCode()){case gu.NO_ERROR:const w=g.getResponseJson();te(Ot,`XHR for RPC '${e}' ${u} received:`,JSON.stringify(w)),h(w);break;case gu.TIMEOUT:te(Ot,`RPC '${e}' ${u} timed out`),m(new ie(H.DEADLINE_EXCEEDED,"Request time out"));break;case gu.HTTP_ERROR:const R=g.getStatus();if(te(Ot,`RPC '${e}' ${u} failed with status:`,R,"response text:",g.getResponseText()),R>0){let V=g.getResponseJson();Array.isArray(V)&&(V=V[0]);const F=V==null?void 0:V.error;if(F&&F.status&&F.message){const G=function(B){const me=B.toLowerCase().replace(/_/g,"-");return Object.values(H).indexOf(me)>=0?me:H.UNKNOWN}(F.status);m(new ie(G,F.message))}else m(new ie(H.UNKNOWN,"Server responded with status "+g.getStatus()))}else m(new ie(H.UNAVAILABLE,"Connection failed."));break;default:ye()}}finally{te(Ot,`RPC '${e}' ${u} completed.`)}});const v=JSON.stringify(o);te(Ot,`RPC '${e}' ${u} sending request:`,o),g.send(t,"POST",v,s,15)})}qo(e,t,s){const o=qh(),u=[this.Fo,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=qy(),m=$y(),g={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},v=this.longPollingOptions.timeoutSeconds;v!==void 0&&(g.longPollingTimeout=Math.round(1e3*v)),this.useFetchStreams&&(g.useFetchStreams=!0),this.Lo(g.initMessageHeaders,t,s),g.encodeInitMessageHeaders=!0;const w=u.join("");te(Ot,`Creating RPC '${e}' stream ${o}: ${w}`,g);const R=h.createWebChannel(w,g);let V=!1,F=!1;const G=new rS({Eo:B=>{F?te(Ot,`Not sending because RPC '${e}' stream ${o} is closed:`,B):(V||(te(Ot,`Opening RPC '${e}' stream ${o} transport.`),R.open(),V=!0),te(Ot,`RPC '${e}' stream ${o} sending:`,B),R.send(B))},Ao:()=>R.close()}),j=(B,me,ne)=>{B.listen(me,ue=>{try{ne(ue)}catch(pe){setTimeout(()=>{throw pe},0)}})};return j(R,ma.EventType.OPEN,()=>{F||(te(Ot,`RPC '${e}' stream ${o} transport opened.`),G.So())}),j(R,ma.EventType.CLOSE,()=>{F||(F=!0,te(Ot,`RPC '${e}' stream ${o} transport closed`),G.Do())}),j(R,ma.EventType.ERROR,B=>{F||(F=!0,io(Ot,`RPC '${e}' stream ${o} transport errored:`,B),G.Do(new ie(H.UNAVAILABLE,"The operation could not be completed")))}),j(R,ma.EventType.MESSAGE,B=>{var me;if(!F){const ne=B.data[0];be(!!ne);const ue=ne,pe=(ue==null?void 0:ue.error)||((me=ue[0])===null||me===void 0?void 0:me.error);if(pe){te(Ot,`RPC '${e}' stream ${o} received error:`,pe);const Fe=pe.status;let Te=function(A){const k=ot[A];if(k!==void 0)return m_(k)}(Fe),N=pe.message;Te===void 0&&(Te=H.INTERNAL,N="Unknown error status: "+Fe+" with message "+pe.message),F=!0,G.Do(new ie(Te,N)),R.close()}else te(Ot,`RPC '${e}' stream ${o} received:`,ne),G.vo(ne)}}),j(m,By.STAT_EVENT,B=>{B.stat===rd.PROXY?te(Ot,`RPC '${e}' stream ${o} detected buffering proxy`):B.stat===rd.NOPROXY&&te(Ot,`RPC '${e}' stream ${o} detected no buffering proxy`)}),setTimeout(()=>{G.bo()},0),G}}function Hh(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _a{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class lv extends iv{constructor(e,t,s,o,u,h){super(e,t,s,o,h),this._firestore=e,this._firestoreImpl=e,this.metadata=u}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new wu(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const s=this._document.data.field(rc("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s,t.serverTimestamps)}}}class wu extends lv{data(e={}){return super.data(e)}}class uv{constructor(e,t,s,o){this._firestore=e,this._userDataWriter=t,this._snapshot=o,this.metadata=new _a(o.hasPendingWrites,o.fromCache),this.query=s}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,t){this._snapshot.docs.forEach(s=>{e.call(t,new wu(this._firestore,this._userDataWriter,s.key,s,new _a(this._snapshot.mutatedKeys.has(s.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new ie(H.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(o,u){if(o._snapshot.oldDocs.isEmpty()){let h=0;return o._snapshot.docChanges.map(m=>{const g=new wu(o._firestore,o._userDataWriter,m.doc.key,m.doc,new _a(o._snapshot.mutatedKeys.has(m.doc.key),o._snapshot.fromCache),o.query.converter);return m.doc,{type:"added",doc:g,oldIndex:-1,newIndex:h++}})}{let h=o._snapshot.oldDocs;return o._snapshot.docChanges.filter(m=>u||m.type!==3).map(m=>{const g=new wu(o._firestore,o._userDataWriter,m.doc.key,m.doc,new _a(o._snapshot.mutatedKeys.has(m.doc.key),o._snapshot.fromCache),o.query.converter);let v=-1,w=-1;return m.type!==0&&(v=h.indexOf(m.doc.key),h=h.delete(m.doc.key)),m.type!==1&&(h=h.add(m.doc),w=h.indexOf(m.doc.key)),{type:hA(m.type),doc:g,oldIndex:v,newIndex:w}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function hA(i){switch(i){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return ye()}}class pf extends uA{constructor(e){super(),this.firestore=e}convertBytes(e){return new ho(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new on(this.firestore,null,t)}}function dA(i){i=li(i,mi);const e=li(i.firestore,co),t=nf(e),s=new pf(e);return sv(i._query),WS(t,i._query).then(o=>new uv(e,s,i,o))}function fA(i){return cv(li(i.firestore,co),[new jd(i._key,Xn.none())])}function pA(i,e){const t=li(i.firestore,co),s=Y_(i),o=cA(i.converter,e);return cv(t,[eA(Z_(i.firestore),"addDoc",s._key,o,i.converter!==null,{}).toMutation(s._key,Xn.exists(!1))]).then(()=>s)}function mA(i,...e){var t,s,o;i=Yt(i);let u={includeMetadataChanges:!1,source:"default"},h=0;typeof e[h]!="object"||qg(e[h])||(u=e[h],h++);const m={includeMetadataChanges:u.includeMetadataChanges,source:u.source};if(qg(e[h])){const R=e[h];e[h]=(t=R.next)===null||t===void 0?void 0:t.bind(R),e[h+1]=(s=R.error)===null||s===void 0?void 0:s.bind(R),e[h+2]=(o=R.complete)===null||o===void 0?void 0:o.bind(R)}let g,v,w;if(i instanceof on)v=li(i.firestore,co),w=Ud(i._key.path),g={next:R=>{e[h]&&e[h](gA(v,i,R))},error:e[h+1],complete:e[h+2]};else{const R=li(i,mi);v=li(R.firestore,co),w=R._query;const V=new pf(v);g={next:F=>{e[h]&&e[h](new uv(v,V,R,F))},error:e[h+1],complete:e[h+2]},sv(i._query)}return function(V,F,G,j){const B=new G_(j),me=new F_(F,B,G);return V.asyncQueue.enqueueAndForget(async()=>M_(await _d(V),me)),()=>{B.eu(),V.asyncQueue.enqueueAndForget(async()=>b_(await _d(V),me))}}(nf(v),w,m,g)}function cv(i,e){return function(s,o){const u=new ai;return s.asyncQueue.enqueueAndForget(async()=>OS(await HS(s),o,u)),u.promise}(nf(i),e)}function gA(i,e,t){const s=t.docs.get(e._key),o=new pf(i);return new lv(i,o,e._key,s,new _a(t.hasPendingWrites,t.fromCache),e.converter)}function yA(){return new uf("serverTimestamp")}(function(e,t=!0){(function(o){mo=o})(fo),no(new Qi("firestore",(s,{instanceIdentifier:o,options:u})=>{const h=s.getProvider("app").getImmediate(),m=new co(new aI(s.getProvider("auth-internal")),new hI(s.getProvider("app-check-internal")),function(v,w){if(!Object.prototype.hasOwnProperty.apply(v.options,["projectId"]))throw new ie(H.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ka(v.options.projectId,w)}(h,o),h);return u=Object.assign({useFetchStreams:t},u),m._setSettings(u),m},"PUBLIC").setMultipleInstances(!0)),oi(ig,"4.7.5",e),oi(ig,"4.7.5","esm2017")})();const _A={apiKey:"AIzaSyAbbKdCPiRfnIidLdPfcIOsp_PzYFzjHOY",authDomain:"gossipgrid-d5173.firebaseapp.com",projectId:"gossipgrid-d5173",storageBucket:"gossipgrid-d5173.firebasestorage.app",messagingSenderId:"121882441252",appId:"1:121882441252:web:b7538754f225f613a74ab1",measurementId:"G-57ETC11PXR"},hv=iy(_A),Uu=rI(hv),vA=new _r,Gh=QS(hv);var hu={};/*!
 * cookie
 * Copyright(c) 2012-2014 Roman Shtylman
 * Copyright(c) 2015 Douglas Christopher Wilson
 * MIT Licensed
 */var Gg;function EA(){if(Gg)return hu;Gg=1,hu.parse=h,hu.serialize=v;var i=Object.prototype.toString,e=Object.prototype.hasOwnProperty,t=/^[!#$%&'*+\-.^_`|~0-9A-Za-z]+$/,s=/^("?)[\u0021\u0023-\u002B\u002D-\u003A\u003C-\u005B\u005D-\u007E]*\1$/,o=/^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i,u=/^[\u0020-\u003A\u003D-\u007E]*$/;function h(F,G){if(typeof F!="string")throw new TypeError("argument str must be a string");var j={},B=F.length;if(B<2)return j;var me=G&&G.decode||w,ne=0,ue=0,pe=0;do{if(ue=F.indexOf("=",ne),ue===-1)break;if(pe=F.indexOf(";",ne),pe===-1)pe=B;else if(ue>pe){ne=F.lastIndexOf(";",ue-1)+1;continue}var Fe=m(F,ne,ue),Te=g(F,ue,Fe),N=F.slice(Fe,Te);if(!e.call(j,N)){var T=m(F,ue+1,pe),A=g(F,pe,T);F.charCodeAt(T)===34&&F.charCodeAt(A-1)===34&&(T++,A--);var k=F.slice(T,A);j[N]=V(k,me)}ne=pe+1}while(ne<B);return j}function m(F,G,j){do{var B=F.charCodeAt(G);if(B!==32&&B!==9)return G}while(++G<j);return j}function g(F,G,j){for(;G>j;){var B=F.charCodeAt(--G);if(B!==32&&B!==9)return G+1}return j}function v(F,G,j){var B=j&&j.encode||encodeURIComponent;if(typeof B!="function")throw new TypeError("option encode is invalid");if(!t.test(F))throw new TypeError("argument name is invalid");var me=B(G);if(!s.test(me))throw new TypeError("argument val is invalid");var ne=F+"="+me;if(!j)return ne;if(j.maxAge!=null){var ue=Math.floor(j.maxAge);if(!isFinite(ue))throw new TypeError("option maxAge is invalid");ne+="; Max-Age="+ue}if(j.domain){if(!o.test(j.domain))throw new TypeError("option domain is invalid");ne+="; Domain="+j.domain}if(j.path){if(!u.test(j.path))throw new TypeError("option path is invalid");ne+="; Path="+j.path}if(j.expires){var pe=j.expires;if(!R(pe)||isNaN(pe.valueOf()))throw new TypeError("option expires is invalid");ne+="; Expires="+pe.toUTCString()}if(j.httpOnly&&(ne+="; HttpOnly"),j.secure&&(ne+="; Secure"),j.partitioned&&(ne+="; Partitioned"),j.priority){var Fe=typeof j.priority=="string"?j.priority.toLowerCase():j.priority;switch(Fe){case"low":ne+="; Priority=Low";break;case"medium":ne+="; Priority=Medium";break;case"high":ne+="; Priority=High";break;default:throw new TypeError("option priority is invalid")}}if(j.sameSite){var Te=typeof j.sameSite=="string"?j.sameSite.toLowerCase():j.sameSite;switch(Te){case!0:ne+="; SameSite=Strict";break;case"lax":ne+="; SameSite=Lax";break;case"strict":ne+="; SameSite=Strict";break;case"none":ne+="; SameSite=None";break;default:throw new TypeError("option sameSite is invalid")}}return ne}function w(F){return F.indexOf("%")!==-1?decodeURIComponent(F):F}function R(F){return i.call(F)==="[object Date]"}function V(F,G){try{return G(F)}catch{return F}}return hu}var Tu=EA();function wA(){const i=typeof global>"u"?void 0:global.TEST_HAS_DOCUMENT_COOKIE;return typeof i=="boolean"?i:typeof document=="object"&&typeof document.cookie=="string"}function TA(i){return typeof i=="string"?Tu.parse(i):typeof i=="object"&&i!==null?i:{}}function Kh(i,e={}){const t=IA(i);if(!e.doNotParse)try{return JSON.parse(t)}catch{}return i}function IA(i){return i&&i[0]==="j"&&i[1]===":"?i.substr(2):i}class dv{constructor(e,t={}){this.changeListeners=[],this.HAS_DOCUMENT_COOKIE=!1,this.update=()=>{if(!this.HAS_DOCUMENT_COOKIE)return;const o=this.cookies;this.cookies=Tu.parse(document.cookie),this._checkChanges(o)};const s=typeof document>"u"?"":document.cookie;this.cookies=TA(e||s),this.defaultSetOptions=t,this.HAS_DOCUMENT_COOKIE=wA()}_emitChange(e){for(let t=0;t<this.changeListeners.length;++t)this.changeListeners[t](e)}_checkChanges(e){new Set(Object.keys(e).concat(Object.keys(this.cookies))).forEach(s=>{e[s]!==this.cookies[s]&&this._emitChange({name:s,value:Kh(this.cookies[s])})})}_startPolling(){this.pollingInterval=setInterval(this.update,300)}_stopPolling(){this.pollingInterval&&clearInterval(this.pollingInterval)}get(e,t={}){return t.doNotUpdate||this.update(),Kh(this.cookies[e],t)}getAll(e={}){e.doNotUpdate||this.update();const t={};for(let s in this.cookies)t[s]=Kh(this.cookies[s],e);return t}set(e,t,s){s?s=Object.assign(Object.assign({},this.defaultSetOptions),s):s=this.defaultSetOptions;const o=typeof t=="string"?t:JSON.stringify(t);this.cookies=Object.assign(Object.assign({},this.cookies),{[e]:o}),this.HAS_DOCUMENT_COOKIE&&(document.cookie=Tu.serialize(e,o,s)),this._emitChange({name:e,value:t,options:s})}remove(e,t){const s=t=Object.assign(Object.assign(Object.assign({},this.defaultSetOptions),t),{expires:new Date(1970,1,1,0,0,1),maxAge:0});this.cookies=Object.assign({},this.cookies),delete this.cookies[e],this.HAS_DOCUMENT_COOKIE&&(document.cookie=Tu.serialize(e,"",s)),this._emitChange({name:e,value:void 0,options:t})}addChangeListener(e){this.changeListeners.push(e),this.HAS_DOCUMENT_COOKIE&&this.changeListeners.length===1&&(typeof window=="object"&&"cookieStore"in window?window.cookieStore.addEventListener("change",this.update):this._startPolling())}removeChangeListener(e){const t=this.changeListeners.indexOf(e);t>=0&&this.changeListeners.splice(t,1),this.HAS_DOCUMENT_COOKIE&&this.changeListeners.length===0&&(typeof window=="object"&&"cookieStore"in window?window.cookieStore.removeEventListener("change",this.update):this._stopPolling())}}const SA=new dv,AA=i=>{const{setIsAuth:e}=i,t=async()=>{try{const s=await dT(Uu,vA);SA.set("auth-token",s.user.refreshToken),e(!0)}catch(s){console.err(s)}};return we.jsx("div",{className:"flex flex-col justify-center items-center",children:we.jsx("button",{onClick:t,className:"border-4 border-blue-400 rounded-md p-2",children:"Sign in With Google"})})};function Kg({isAuth:i,logout:e,auth:t}){var s;return we.jsxs("div",{className:"relative flex items-center border-b-2 border-black bg-blue-400 h-16",children:[we.jsx("div",{className:"absolute left-1/2 transform -translate-x-1/2 text-5xl text-white",children:"GossipGrid"}),i&&we.jsxs("div",{className:"ml-auto flex items-center space-x-4 mr-4",children:[we.jsx("div",{className:"text-white text-lg font-medium",children:(s=t.currentUser)==null?void 0:s.displayName}),we.jsx("button",{onClick:e,className:"bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600",children:"Logout"})]})]})}function RA({room:i,setRoom:e}){const[t,s]=Vn.useState(""),[o,u]=Vn.useState([]),h=Bg(Gh,"messages"),m=Vn.useRef(null),g=async w=>{try{const V=(await dA(Bg(Gh,w))).docs.map(F=>fA(Y_(Gh,w,F.id)));await Promise.all(V),console.log(`All documents in "${w}" deleted successfully!`)}catch(R){console.error("Error deleting documents: ",R)}};Vn.useEffect(()=>{const w=oA(h,aA("room","==",i),lA("createdAt")),R=mA(w,V=>{let F=[];V.forEach(G=>{F.push({...G.data(),id:G.id})}),u(F)});return()=>R()},[i]),Vn.useEffect(()=>{var w;(w=m.current)==null||w.scrollIntoView({behavior:"smooth"})},[o]);const v=async w=>{var R;if(w.preventDefault(),t.trim()!=="")try{await pA(h,{text:t,createdAt:yA(),user:((R=Uu.currentUser)==null?void 0:R.displayName)||"Anonymous",room:i}),s("")}catch(V){console.error(V)}};return we.jsxs("div",{className:"flex flex-col h-screen max-w-full p-4 border-2 border-gray-400 rounded-lg",children:[we.jsxs("div",{className:"flex items-center justify-between border-b-2 border-gray-400 mb-2 p-2",children:[we.jsx("button",{onClick:()=>e(!1),className:"bg-gray-300 font-bold p-2 rounded hover:bg-gray-400 transition-all duration-150",children:"Back"}),we.jsx("button",{onClick:()=>g("messages"),className:"bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600 hover:scale-105 transition-all duration-500 delay-75",children:"Clear Chat"}),we.jsx("div",{className:"text-center font-bold text-lg",children:i})]}),we.jsxs("div",{className:"flex-1 overflow-y-auto space-y-2 p-2",children:[o.map(w=>{var V;const R=w.user===((V=Uu.currentUser)==null?void 0:V.displayName);return we.jsx("div",{className:`flex ${R?"justify-end":"justify-start"}`,children:we.jsxs("div",{className:`p-3 rounded-lg shadow max-w-full break-words ${R?"bg-blue-500 text-white":"bg-gray-100 text-gray-800"}`,children:[we.jsx("h2",{className:"font-bold mb-1",children:w.user}),we.jsx("p",{children:w.text})]})},w.id)}),we.jsx("div",{ref:m})]}),we.jsxs("form",{onSubmit:v,className:"flex mt-4 space-x-2",children:[we.jsx("input",{placeholder:"Message",onChange:w=>s(w.target.value),value:t,className:"flex-1 border p-2 rounded-md"}),we.jsx("button",{type:"submit",className:"bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600",children:"Send"})]})]})}const Qg=new dv;function CA(){const[i,e]=Vn.useState(Qg.get("auth-token")),[t,s]=Vn.useState(null),[o,u]=Vn.useState(!1),h=Vn.useRef(null);Vn.useEffect(()=>{const w=sessionStorage.getItem("room");w&&s(w)},[]);const m=w=>{w&&(s(w),sessionStorage.setItem("room",w))},g=()=>{s(null),sessionStorage.removeItem("room")},v=async()=>{await Ww(Uu),Qg.remove("auth-token"),sessionStorage.removeItem("room"),e(!1),s(null)};return i?we.jsxs("div",{className:"flex h-screen",children:[we.jsxs("div",{className:`fixed inset-y-0 left-0 z-50 w-64 bg-blue-500 text-white transform ${o?"translate-x-0":"-translate-x-full"} transition-transform duration-300 lg:static lg:translate-x-0`,children:[we.jsx("div",{className:"p-4 font-bold text-lg border-b border-blue-400",children:"GossipGrid"}),we.jsx("nav",{className:"p-4 space-y-2",children:we.jsx("button",{onClick:v,className:"w-full bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded",children:"Logout"})})]}),we.jsxs("div",{className:"flex-1 flex flex-col overflow-hidden",children:[we.jsx(Kg,{}),we.jsx("div",{className:"flex flex-1 items-center justify-center p-4",children:t?we.jsx("div",{className:"w-full max-w-lg h-full border-2 border-gray-400 rounded-lg",children:we.jsx(RA,{room:t,setRoom:g})}):we.jsxs("div",{className:"flex flex-col items-center w-full max-w-md space-y-4",children:[we.jsx("label",{className:"text-2xl font-bold text-center",children:"Room Name"}),we.jsx("input",{ref:h,className:"w-full border-2 border-blue-400 rounded-md p-2 outline-none focus:ring-2 focus:ring-blue-400"}),we.jsx("button",{onClick:()=>m(h.current.value),className:"w-full p-2 text-lg bg-blue-500 text-white rounded-md hover:bg-blue-600",children:"Enter"})]})})]}),we.jsx("button",{onClick:()=>u(!o),className:"fixed bottom-4 left-4 z-50 bg-blue-500 text-white p-3 rounded-full lg:hidden",children:o?"Close":"Menu"})]}):we.jsxs("div",{className:"flex flex-col h-screen",children:[we.jsx(Kg,{}),we.jsx("div",{className:"flex flex-1 items-center justify-center",children:we.jsx(AA,{setIsAuth:e})})]})}S0.createRoot(document.getElementById("root")).render(we.jsx(Vn.StrictMode,{children:we.jsx(CA,{})}));
